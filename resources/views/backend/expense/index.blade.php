        ...
        <div class="border-0 mb-4">
          <div class="card-header py-3 no-bg bg-transparent d-flex align-items-center px-0 justify-content-between border-bottom flex-wrap">
            ...
            <div class="btn-group " role="group" aria-label="Basic mixed styles example">
              <a href="{{route('expense.index')}}" class="btn text-white " style="background:#9479ed ">All</a>
              <a href="{{route('expense.filter',$id=1)}}" class="btn text-white" style="background:#7056c7 ">Day</a>
              <a href="{{route('expense.filter',$id=2)}}" class="btn text-white" style="background:#50399e ">Month</a>
              <a href="{{route('expense.filter',$id=3)}}" class="btn text-white" style="background:#37237a ">Year</a>
              <a class="btn border-primary ">Total : <span class="text-dark text-bold"  style="font-weight: 700">{{ $SumAmount }}</span> টাকা</a>
              
          </div>
            {{-- <h3 class="fw-bold mb-0">All expense List</h3> --}}


            <div class="col-auto d-flex w-sm-100">
              <button type="button" class="btn btn-primary btn-set-task w-sm-100" data-bs-toggle="modal" data-bs-target="#expadd">
                <i class="icofont-plus-circle me-2 fs-6"></i>Add New Expense</button>
            </div>
          </div>
                        ...
                        <tr role="row" class="even">
                          ...
                          <td class=" dt-body-right" style="display: none;">
                            <div class="btn-group" role="group" aria-label="Basic outlined example">
                              ...
                              <a href="{{ route('expense.destroy',$data->id) }}" onclick="confirmation(event)" class="btn btn-outline-secondary deleterow deletetBTN">
        ...
        <div class="modal-dialog modal-dialog-centered modal-md modal-dialog-scrollable">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title fw-bold" id="expaddLabel"> Add New Expense  <span class="spinner-border spinner-border-sm text-primary submitBTNLoading" role="status" aria-hidden="true"></span></h5>
            ...
            <div class="modal-body">
              ...
              <div class="deadline-form">
                <form class="row g-3 needs-validation" novalidate action="{{ route('expense.store') }}" method="post" enctype="multipart/form-data">
                  @csrf
                 <div class="">
                    <label class="form-label">Select Name</label><span> </span><i class="icofont-exclamation-circle fs-7"></i>
                    <select class="" id="selectbox" name="expense_id" id="validationCustom05" required>
                  ...
                  <div class="row g-3 ">
                    ...
                    <div class="col-sm-6">
                      <label class="form-label">expense Date</label>
                                    <input type="date" name="expense_date" class="form-control w-100" id="validationCustom03" required value="@php
