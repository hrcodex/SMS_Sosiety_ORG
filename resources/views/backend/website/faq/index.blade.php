    ...
    <div class="container-xxl">
        <div class="row align-items-center">
            <div class="border-0 mb-4">
                <div class="card-header py-3 no-bg bg-transparent d-flex align-items-center px-0 justify-content-between border-bottom flex-wrap">
                    <h3 class="fw-bold mb-0">প্রশ্ন উত্তর : {{ count($data) }}</h3>
                    <div class="btn-group group-link btn-set-task w-sm-100">
                        ...
                        <button data-bs-toggle="modal" data-bs-target="#addFaq" class="btn active d-inline-flex align-items-center"><i class="icofont-plus-square px-2 fs-5"></i>Add New FAQ</button>
                    </div>
                </div>
        ...
        <div class="row g-3 mb-3">
            ...
            <div class="card card-callout mb-3 {{ $item->publication_status == 'Published' ?'border-success':'border-warning' }}">
                <div class="card-body">
                    <h4 id="asynchronous-methods-and-transitions"><span>{{ ++$key }} .</span>{{ $item->question }}</h4>
                    <p>{!! $item->answer !!}</p>
                    ...
                    <a href="{{ route('faq.destroy',$item->id) }}" onclick="confirmation(event)" class="btn btn-danger deletetBTN">
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <div class="deadline-form">
                <form class="row g-3 needs-validation" novalidate action="{{ route('faq.store') }}" method="post">
                  @csrf
               
                  <div class="mb-3">
                      <label class="form-label">Question</label><span> </span><i class="icofont-exclamation-circle fs-7"></i>
                      <input type="text" name="question" placeholder="প্রশ্ন ....?" class="form-control" id="validationCustom03" required>
                    </div>
                    <div class="mb-3">
                      <label class="form-label">Answer</label>
                      <textarea class="form-control" name="answer" placeholder="উত্তর ..." rows="5" cols="30" required=""></textarea>
                    </div>
                    <div class="mb-3">
        ...
        <div class="modal-dialog modal-dialog-centered modal-md modal-dialog-scrollable">
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <div class="deadline-form">
                <form class="row g-3 needs-validation" novalidate action="{{ route('faq.update') }}" method="post">
                  @csrf
               
                    <div class="mb-3">
                        <label class="form-label">Question</label><span> </span><i class="icofont-exclamation-circle fs-7"></i>
                        <input type="text" name="question" placeholder="Question ...." class="form-control question" id="validationCustom03" required>
                        <input type="hidden" name="id" class="form-control id">
                      </div>
                      <div class="mb-3">
                        <label class="form-label">Answer</label>
                        <textarea class="form-control answer" name="answer" placeholder="answer ..." rows="5" cols="30" required=""></textarea>
                      </div>
                      <div class="mb-3">
                        <label class="form-label">Publication Status</label><span> </span><i class="icofont-exclamation-circle fs-7"></i>
