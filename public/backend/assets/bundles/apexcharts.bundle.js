! function(t, e) {
    ...
    var X = o,
        A = (t(Q, [{
            ...
            value: function(t, e, i, a, s, o, r, n) {
                ...
                (!s || -1 < s.indexOf("undefined") || -1 < s.indexOf("NaN")) && (s = l()), (!o || -1 < o.indexOf("undefined") || -1 < o.indexOf("NaN")) && (o = l()), c.globals.shouldAnimate || (r = 1), t.plot(s).animate(1, c.globals.easing, n).plot(s).animate(r, c.globals.easing, n).plot(o).afterAll(function() {
                    X.isNumber(i) ? i === c.globals.series[c.globals.maxValsInArrayIndex].length - 2 && c.globals.shouldAnimate && h.animationCompleted(t) : "none" !== a && c.globals.shouldAnimate && (!c.globals.comboCharts && e === c.globals.series.length - 1 || c.globals.comboCharts) && h.animationCompleted(t), h.showDelayedElements()
                })
            }
        }]), Q),
        S = (t(J, [{
            ...
            value: function(t, e) {
                var i = 2 < arguments.length && void 0 !== arguments[2] ? arguments[2] : 0,
                    ...
                    l = this.w;
                return t.unfilter(!0), X.isIE() && "radialBar" === l.config.chart.type || (r = Array.isArray(r) ? r[i] : r, t.filter(function(t) {
                    var e = X.isSafari() || X.isFirefox() || X.isIE() ? t.flood(r, n).composite(t.sourceAlpha, "in").offset(s, a).gaussianBlur(o) : t.flood(r, n).composite(t.sourceAlpha, "in").offset(s, a).gaussianBlur(o).merge(t.source);
                    t.blend(t.source, e)
        ...
        E = (t($, [{
            ...
            value: function(t) {
                ...
                return !m || f.globals.resized || f.globals.dataChanged ? !f.globals.resized && f.globals.dataChanged || b.showDelayedElements() : b.animatePathsGradually(P(P({}, g), {}, {
                    speed: c
                })), f.globals.dataChanged && y && v && b.animatePathsGradually(P(P({}, g), {}, {
                    speed: d
                })), k
            }
        }, {
            ...
            value: function(t, e, i, a, s) {
                var o, r = 5 < arguments.length && void 0 !== arguments[5] ? arguments[5] : null,
                    ...
                    c = this.w,
                    d = (e.length < 9 && 0 === e.indexOf("#") && (e = X.hexToRgba(e, a)), i.length < 9 && 0 === i.indexOf("#") && (i = X.hexToRgba(i, s)), 0),
                    g = 1,
                    u = 1,
                    p = null,
            ...
            value: function(t) {
                var i = this,
                    ...
                    t = Array.isArray(s) ? u.globals.dom.Paper.text(function(t) {
                        for (var e = 0; e < s.length; e++) p = s[e], d && (p = i.getTextBasedOnMaxWidth(P({
                            text: s[e]
            ...
            value: function(t, e, i) {
                ...
                }), r = s) : "circle" !== i.shape && i.shape || (X.isNumber(e) || (e = o = 0), r = this.drawCircle(o, {
                    cx: t,
                    cy: e,
                    class: i.class || "",
                    stroke: i.pointStrokeColor,
        ...
        s = (t(q, [{
            ...
            value: function(t, e) {
                var i, a, t = "y1" === t ? e.y : e.y2,
                    s = this.w;
                return this.annoCtx.invertAxis ? (i = s.globals.labels.indexOf(t), s.config.xaxis.convertedCatToNumeric && (i = s.globals.categoryLabels.indexOf(t)), (i = s.globals.dom.baseEl.querySelector(".apexcharts-yaxis-texts-g text:nth-child(" + (i + 1) + ")")) && (a = parseFloat(i.getAttribute("y")))) : (i = s.config.yaxis[e.yAxisIndex].logarithmic ? (t = new T(this.annoCtx.ctx).getLogVal(t, e.yAxisIndex)) / s.globals.yLogRatio[e.yAxisIndex] : (t - s.globals.minYArr[e.yAxisIndex]) / (s.globals.yRange[e.yAxisIndex] / s.globals.gridHeight), a = s.globals.gridHeight - i, !e.marker || void 0 !== e.y && null !== e.y || (a = 0), s.config.yaxis[e.yAxisIndex] && s.config.yaxis[e.yAxisIndex].reversed && (a = i)), a
            }
        }, {
            key: "getX1X2",
            value: function(t, e) {
                ...
                return this.annoCtx.inversedReversedAxis && (a = (s - e.x2) / (o / i.globals.gridWidth)), "category" !== i.config.xaxis.type && !i.config.xaxis.convertedCatToNumeric || this.annoCtx.invertAxis || i.globals.dataFormatXNumeric || (a = this.getStringX(e.x2)), void 0 !== e.x && null !== e.x || !e.marker || (r = i.globals.gridWidth), "x1" === t ? r : a
            }
        }, {
            key: "getStringX",
            value: function(t) {
    ...
    function j(t) {
        a(this, j), this.w = t.w, this.annoCtx = t, this.helpers = new s(this.annoCtx)
    }

    function _(t) {
        a(this, _), this.w = t.w, this.annoCtx = t, this.helpers = new s(this.annoCtx)
    }

    function U(t) {
        a(this, U), this.w = t.w, this.annoCtx = t, this.invertAxis = this.annoCtx.invertAxis, this.helpers = new s(this.annoCtx)
    }
    ...
    function K(t) {
        var e = t.ctx,
            ...
            d = ("function" == typeof d && (h = d(h, g)), null != (d = t.config.series[i].data[a]) && d.x && (l = t.config.series[i].data[a].x + ":"), "function" == typeof c && (l = c(l, g)), Number.isFinite(s) && Number.isFinite(o) && (r = s, n = o), ""),
            a = "",
            c = t.globals.colors[i];
        return a = void 0 === t.config.tooltip.x.formatter ? "datetime" === t.config.xaxis.type ? (d = (g = new v(e)).formatDate(g.getDate(r), t.config.tooltip.x.format), g.formatDate(g.getDate(n), t.config.tooltip.x.format)) : (d = r, n) : (d = t.config.tooltip.x.formatter(r), t.config.tooltip.x.formatter(n)), {
            start: r,
            end: n,
            startVal: d,
            endVal: a,
    ...
    var et, it, at, st, ot, rt = {
        ...
        nt = (t($e, [{
            ...
            value: function(t) {
                ...
                }), t = X.listToArray(t), Array.prototype.forEach.call(t, function(t) {
        ...
        v = (t(Ze, [{
            ...
            value: function(t, e) {
                var i = 30;
                return t = X.monthMod(t), !0 == -1 < this.months30.indexOf(t) ? 2 === t && (i = this.isLeapYear(e) ? 29 : 28) : (this.months31.indexOf(t), i = 31), i
            }
        }]), Ze),
        r = (t(qe, [{
            key: "line",
            ...
            value: function() {
                return {
                    ...
                    tooltip: {
                        ...
                        followCursor: !0,
                        custom: function(t) {
                            return t.w.config.plotOptions && t.w.config.plotOptions.bar && t.w.config.plotOptions.bar.horizontal ? (e = K(t), i = e.color, a = e.seriesName, s = e.ylabel, o = e.startVal, e = e.endVal, tt({
                                color: i,
                                seriesName: a,
                                ylabel: s,
                                start: o,
                                end: e
                            })) : (i = K(t), a = i.color, s = i.seriesName, o = i.ylabel, e = i.start, i = i.end, tt({
                                color: a,
                                seriesName: s,
                                ylabel: o,
                                start: e,
            ...
            value: function() {
                return {
                    ...
                    tooltip: {
                        ...
                        followCursor: !0,
                        custom: function(t) {
                            return e = K(t = t), i = e.color, a = e.seriesName, s = e.ylabel, o = e.start, e = e.end, tt(P(P({}, t), {}, {
                                color: i,
                                seriesName: a,
                                ylabel: s,
                                start: o,
        ...
        p = (t(Ue, [{
            ...
            value: function(i, t) {
                var a = new d,
                    e = ((void 0 === i.yaxis || !i.yaxis || Array.isArray(i.yaxis) && 0 === i.yaxis.length) && (i.yaxis = {}), i.yaxis.constructor !== Array && window.Apex.yaxis && window.Apex.yaxis.constructor !== Array && (i.yaxis = X.extend(i.yaxis, window.Apex.yaxis)), i.yaxis.constructor !== Array ? i.yaxis = [X.extend(a.yAxis, i.yaxis)] : i.yaxis = X.extendArray(i.yaxis, a.yAxis), !1),
                    s = (i.yaxis.forEach(function(t) {
                        t.logarithmic && (e = !0)
                    }), i.series);
                return t && !s && (s = t.config.series), e && s.length !== i.yaxis.length && s.length && (i.yaxis = s.map(function(t, e) {
                    return t.name || (s[e].name = "series-".concat(e + 1)), i.yaxis[e] ? (i.yaxis[e].seriesName = s[e].name, i.yaxis[e]) : ((t = X.extend(a.yAxis, i.yaxis[0])).show = !1, t)
        ...
        C = (t(Ge, [{
            ...
            value: function(t) {
                ...
                i.appendChild(a), a.setAttributeNS(window.SVG.xlink, "href", s), E.setAttrs(a, {
                    x: 0,
                    y: 0,
            ...
            value: function(t) {
                ...
                return -1 === o.indexOf("rgb") ? o.length < 9 && (l = X.hexToRgba(o, n)) : -1 < o.indexOf("rgba") && (n = X.getOpacityFromRGBA(o)), t.opacity && (n = t.opacity), "pattern" === r && (i = this.handlePatternFill({
                ...
                if ((0 < r.globals.markers.size[e] || o || d) && (h = c.group({
                    ...
                    for (var g = 0; g < l.x.length; g++) {
                        var u = 1 === i && 1 === g ? 1 : 1 === i && 0 === g ? 0 : i,
                            p = "apexcharts-marker";
                        "line" !== r.config.chart.type && "area" !== r.config.chart.type || r.globals.comboCharts || r.config.tooltip.intersect || (p += " no-pointer-events"), (Array.isArray(r.config.markers.size) ? 0 < r.globals.markers.size[e] : 0 < r.config.markers.size) || o || d ? (X.isNumber(l.y[g]) ? p += " w".concat(X.randomId()) : p = "apexcharts-nullpoint", p = this.getMarkerConfig({
                            cssClass: p,
                            seriesIndex: e,
                            dataPointIndex: u
                        }), r.config.series[n].data[u] && (r.config.series[n].data[u].fillColor && (p.pointFillColor = r.config.series[n].data[u].fillColor), r.config.series[n].data[u].strokeColor && (p.pointStrokeColor = r.config.series[n].data[u].strokeColor)), a && (p.pSize = a), (s = c.drawMarker(l.x[g], l.y[g], p)).attr("rel", u), s.attr("j", u), s.attr("index", e), s.node.setAttribute("default-marker-size", p.pSize), new S(this.ctx).setSelectionFilter(s, e, u), this.addEvents(s), h && h.add(s)) : (void 0 === r.globals.pointsArray[e] && (r.globals.pointsArray[e] = []), r.globals.pointsArray[e].push([l.x[g], l.y[g]]))
                    }
                return h
            }
        }, {
                ...
                if (h.attr("clip-path", "url(#gridRectMarkerMask".concat(a.globals.cuid, ")")), Array.isArray(r.x))
                    for (var c = 0; c < r.x.length; c++) {
                        var d = e + 1,
                            ...
                            f = (n !== 1 / 0 && (p = a.globals.seriesZ[o][d] / n, (f = a.config.plotOptions.bubble).minBubbleRadius && p < f.minBubbleRadius && (p = f.minBubbleRadius), f.maxBubbleRadius && p > f.maxBubbleRadius && (p = f.maxBubbleRadius)), a.config.chart.animations.enabled || (u = p), r.x[c]),
                            x = r.y[c],
                            u = u || 0;
        ...
        k = (t(We, [{
            ...
            value: function(t) {
                ...
                for (var g = t.group({
                    ...
                    }, "bubble" === l.config.chart.type ? (f = x(p = l.globals.seriesZ[s][d]), c = a.y[u], c = new ct(this.ctx).centerTextInBubble(c, s, d).y) : void 0 !== p && (f = x(p)), this.plotDataLabelsText({
                        x: b,
                        y: c,
                        text: f,
                        i: s,
            ...
            value: function(t) {
                ...
                Array.isArray(i.config.dataLabels.enabledOnSeries) && i.config.dataLabels.enabledOnSeries.indexOf(r) < 0 || (e = {
                    ...
                    cx: s,
                    cy: o
                }), g.dropShadow.enabled && (a = g.dropShadow, new S(this.ctx).dropShadow(e, a)), d.add(e), void 0 === i.globals.lastDrawnDataLabelsIndexes[r] && (i.globals.lastDrawnDataLabelsIndexes[r] = []), i.globals.lastDrawnDataLabelsIndexes[r].push(n)))
            }
        }, {
            ...
            value: function(t, e) {
                var i = this.w,
                    ...
                    r = e.width,
                    n = e.height,
                    e = new E(this.ctx).drawRect(e.x - s, e.y - o / 2, r + 2 * s, n + o, a.borderRadius, "transparent" === i.config.chart.background ? "#fff" : i.config.chart.background, a.opacity, a.borderWidth, a.borderColor);
            ...
            value: function() {
                ...
                if (1 < a.config.series.length)
                    for (var s = a.config.series.map(function(t, e) {
                            return t.data && 0 < t.data.length && (!a.globals.comboCharts || 0 === i.length || i.length && -1 < i.indexOf(a.config.series[e].type)) ? e : -1
        ...
        dt = (t(Ne, [{
            ...
            value: function(t, e) {
                ...
                for (var r = 0; r < t[e].data.length; r++) void 0 !== t[e].data[r].y && (Array.isArray(t[e].data[r].y) ? this.twoDSeries.push(X.parseNumber(t[e].data[r].y[t[e].data[r].y.length - 1])) : this.twoDSeries.push(X.parseNumber(t[e].data[r].y))), void 0 !== t[e].data[r].goals && Array.isArray(t[e].data[r].goals) ? (void 0 === this.seriesGoals[e] && (this.seriesGoals[e] = []), this.seriesGoals[e].push(t[e].data[r].goals)) : (void 0 === this.seriesGoals[e] && (this.seriesGoals[e] = []), this.seriesGoals[e].push(null));
            ...
            value: function(t) {
                ...
                s.isRangeBar = "rangeBar" === a.chart.type && s.isBarHorizontal, s.hasGroups = "category" === a.xaxis.type && 0 < a.xaxis.group.groups.length, s.hasGroups && (s.groups = a.xaxis.group.groups);
                for (var n = 0; n < t.length; n++) {
                    ...
                    if ("rangeBar" !== a.chart.type && "rangeArea" !== a.chart.type && "rangeBar" !== t[n].type && "rangeArea" !== t[n].type || (s.isRangeData = !0, s.isComboCharts ? "rangeBar" !== t[n].type && "rangeArea" !== t[n].type || this.handleRangeData(t, n) : "rangeBar" !== a.chart.type && "rangeArea" !== a.chart.type || this.handleRangeData(t, n)), this.isMultiFormat()) this.isFormat2DArray() ? this.handleFormat2DArray(t, n) : this.isFormatXY() && this.handleFormatXY(t, n), "candlestick" !== a.chart.type && "candlestick" !== t[n].type && "boxPlot" !== a.chart.type && "boxPlot" !== t[n].type || this.handleCandleStickBoxData(t, n), s.series.push(this.twoDSeries), s.labels.push(this.twoDSeriesX), s.seriesX.push(this.twoDSeriesX), s.seriesGoals = this.seriesGoals, n !== this.activeSeriesIndex || this.fallbackToCategory || (s.isXNumeric = !0);
                    else {
                            ...
                            s.isXNumeric = !0; {
                                ...
                                for (var l = 0; l < r.length; l++)
                                    if ("string" == typeof r[l]) {
                                        if (!o.isValidDate(r[l])) throw new Error("You have provided invalid Date format. Please provide a valid JavaScript Date");
                    ...
                    s.seriesZ.push(this.threeDSeries), void 0 !== t[n].name ? s.seriesNames.push(t[n].name) : s.seriesNames.push("series-" + parseInt(n + 1, 10)), void 0 !== t[n].color ? s.seriesColors.push(t[n].color) : s.seriesColors.push(void 0)
                }
                return this.w
            }
        }, {
            ...
            value: function(t) {
                var e = this.w,
                    i = e.config,
                    a = e.globals;
                this.excludeCollapsedSeriesInYAxis(), this.fallbackToCategory = !1, this.ctx.core.resetGlobals(), this.ctx.core.isMultipleY(), a.axisCharts ? (this.parseDataAxisCharts(t), this.coreUtils.getLargestSeries()) : this.parseDataNonAxisCharts(t), "bar" === i.chart.type && i.chart.stacked && (e = new m(this.ctx), a.series = e.setNullSeriesToZeroValues(a.series)), this.coreUtils.getSeriesTotals(), a.axisCharts && (a.stackedSeriesTotals = this.coreUtils.getStackedSeriesTotals()), this.coreUtils.getPercentSeries(), a.dataFormatXNumeric || a.isXNumeric && ("numeric" !== i.xaxis.type || 0 !== i.labels.length || 0 !== i.xaxis.categories.length) || this.handleExternalLabelsData(t);
        ...
        gt = (t(He, [{
            ...
            value: function(t, e, i) {
                var a = this.w;
                return t = X.isNumber(t) ? 0 !== a.globals.yValueDecimal ? t.toFixed(void 0 !== e.decimalsInFloat ? e.decimalsInFloat : a.globals.yValueDecimal) : a.globals.maxYArr[i] - a.globals.minYArr[i] < 5 ? t.toFixed(1) : t.toFixed(0) : t
            }
        }, {
        ...
        L = (t(De, [{
            ...
            value: function(t, e, i, a) {
                var s, o = 4 < arguments.length && void 0 !== arguments[4] ? arguments[4] : [],
                    ...
                    }), u = s === p, i = e[a].position, c = e[a].value) : "datetime" === l.config.xaxis.type && void 0 === g && (c = ""), void 0 === c && (c = ""), c = Array.isArray(c) ? c : c.toString(), new E(this.ctx)),
        ...
        ut = (t(Re, [{
            ...
            value: function(t) {
                var e;
                return X.isIE11() ? (e = 0, t.replace(/xmlns="http:\/\/www.w3.org\/2000\/svg"/g, function(t) {
            ...
            value: function(n) {
                ...
                return new Promise(function(e) {
                    ...
                    window.canvg && X.isIE11() ? ((s = window.canvg.Canvg.fromString(r, a, {
                        ignoreClear: !0,
                        ignoreDimensions: !0
            ...
            value: function(t) {
                var s = this,
                    ...
                    p = Math.max.apply(Math, b(l.map(function(t) {
                    ...
                    x = function(t) {
                        var e, i, a = "";
                        return c.globals.axisCharts ? ("category" !== c.config.xaxis.type && !c.config.xaxis.convertedCatToNumeric || (a = c.globals.isBarHorizontal ? (e = c.globals.yLabelFormatters[0], i = new m(s.ctx).getActiveConfigSeriesIndex(), e(c.globals.labels[t], {
                            seriesIndex: i,
                            dataPointIndex: t,
                            w: c
                        })) : o.getLabel(c.globals.labels, c.globals.timescaleLabels, 0, t).text), "datetime" === c.config.xaxis.type && (c.config.xaxis.categories.length ? a = c.config.xaxis.categories[t] : c.config.labels.length && (a = c.config.labels[t]))) : a = c.config.labels[t], Array.isArray(a) && (a = a.join(" ")), X.isNumber(a) ? a : a.split(h).join("")
                    };
                ...
                }), c.globals.axisCharts || (d.push(c.config.chart.toolbar.export.csv.headerValue), g.push(d.join(h))), l.map(function(t, e) {
                    if (c.globals.axisCharts) {
                        var i, a = t,
                            s = e;
                        if (d.length && 0 === s && g.push(d.join(h)), a.data) {
                            a.data = a.data.length && a.data || b(Array(p)).map(function() {
                                return ""
                            });
                            for (var o = 0; o < a.data.length; o++) {
                                d = [];
                                var r = x(o);
                                if (r || (f.isFormatXY() ? r = l[s].data[o].x : f.isFormat2DArray() && (r = l[s].data[o] ? l[s].data[o][0] : "")), 0 === s) {
                                    d.push((i = r, "datetime" === c.config.xaxis.type && 10 <= String(i).length ? c.config.chart.toolbar.export.csv.dateFormatter(r) : X.isNumber(r) ? r : r.split(h).join("")));
                                    for (var n = 0; n < c.globals.series.length; n++) f.isFormatXY() ? d.push(l[n].data[o].y) : d.push(u[n][o])
                                }("candlestick" === c.config.chart.type || a.type && "candlestick" === a.type) && (d.pop(), d.push(c.globals.seriesCandleO[s][o]), d.push(c.globals.seriesCandleH[s][o]), d.push(c.globals.seriesCandleL[s][o]), d.push(c.globals.seriesCandleC[s][o])), ("boxPlot" === c.config.chart.type || a.type && "boxPlot" === a.type) && (d.pop(), d.push(c.globals.seriesCandleO[s][o]), d.push(c.globals.seriesCandleH[s][o]), d.push(c.globals.seriesCandleM[s][o]), d.push(c.globals.seriesCandleL[s][o]), d.push(c.globals.seriesCandleC[s][o])), "rangeBar" === c.config.chart.type && (d.pop(), d.push(c.globals.seriesRangeStart[s][o]), d.push(c.globals.seriesRangeEnd[s][o])), d.length && g.push(d.join(h))
                            }
                        }
        ...
        g = (t(Fe, [{
            ...
            value: function() {
                ...
                }), a.add(l), i.add(a)), t.config.xaxis.axisBorder.show && (l = t.globals.barPadForNumericAxis, a = e.drawLine(t.globals.padHorizontal + t.config.xaxis.axisBorder.offsetX - l, this.offY, this.xaxisBorderWidth + l, this.offY, t.config.xaxis.axisBorder.color, 0, this.xaxisBorderHeight), i.add(a)), i
            }
        }, {
            ...
            value: function(s) {
                ...
                if (u.show)
                    for (var a = 0; a <= h.length - 1; a++) ! function(i) {
                        var t = void 0 === h[i] ? "" : h[i],
                            ...
                            a = 0,
                            a = (Array.isArray(t) && (a = t.length / 2 * parseInt(u.style.fontSize, 10)), n.drawText({
                                x: u.offsetX - 15,
                                y: d + c + u.offsetY - a,
                                text: t,
                            ...
                            e = (l.add(a), a.on("click", function(t) {
                                var e;
                        ...
                        e.textContent = Array.isArray(t) ? t.join(" ") : t, a.node.appendChild(e), 0 !== r.config.yaxis[s].labels.rotate && (t = n.rotateAroundCenter(a.node), a.node.setAttribute("transform", "rotate(".concat(r.config.yaxis[s].labels.rotate, " 0 ").concat(t.y, ")"))), d += c
                    }(a);
                void 0 !== r.config.yaxis[0].title.text && (t = n.group({
                ...
                var p = 0,
                    t = (this.isCategoryBarHorizontal && r.config.yaxis[0].opposite && (p = r.globals.gridWidth), r.config.xaxis.axisBorder);
                return t.show && (t = n.drawLine(r.globals.padHorizontal + t.offsetX + p, 1 + t.offsetY, r.globals.padHorizontal + t.offsetX + p, r.globals.gridHeight + t.offsetY, t.color, 0), e.add(t)), r.config.yaxis[0].axisTicks.show && this.axesUtils.drawYAxisTicks(p, h.length, r.config.yaxis[0].axisBorder, r.config.yaxis[0].axisTicks, 0, c, e), e
            }
        }, {
            key: "drawXaxisTicks",
            value: function(t, e, i) {
        ...
        pt = (t(Ye, [{
            ...
            value: function(t) {
                ...
                if (!(0 === e && n.globals.skipFirstTimelinelabel || e === r - 1 && n.globals.skipLastTimelinelabel && !n.config.xaxis.labels.formatter || "radar" === n.config.chart.type)) {
                    ...
                    r = 0;
                    if (n.globals.hasGroups && "between" === n.config.xaxis.tickPlacement) {
                        var l = n.globals.groups;
                        if (l) {
                            for (var h = 0, c = 0; h < e && c < l.length; c++) h += l[c].cols;
                            h === e && (r = .6 * n.globals.xAxisLabelsHeight)
                        }
                    }
                    new g(this.ctx).drawXaxisTicks(i, r, this.elg)
                }
            }
        }, {
            key: "_drawGridLine",
            value: function(t) {
                var e = t.x1,
                    ...
                    t = t.parent,
                    o = this.w,
                    r = t.node.classList.contains("apexcharts-gridlines-horizontal"),
                    n = o.config.grid.strokeDashArray,
                    l = o.globals.barPadForNumericAxis,
                    e = new E(this).drawLine(e - (r ? l : 0), i, a + (r ? l : 0), s, o.config.grid.borderColor, n);
            ...
            value: function(t) {
                ...
                if ((h.config.grid.xaxis.lines.show || h.config.xaxis.axisTicks.show) && (t = h.globals.padHorizontal, e = h.globals.gridHeight, (h.globals.timescaleLabels.length ? function(t) {
                        ...
                        var e = t.xC,
                            ...
                            s = t.x2,
                            o = t.y2;
                        if (void 0 !== h.config.xaxis.tickAmount && "dataPoints" !== h.config.xaxis.tickAmount && "on" === h.config.xaxis.tickPlacement) h.globals.dom.baseEl.querySelectorAll(".apexcharts-text.apexcharts-xaxis-label tspan:not(:empty)").forEach(function(t, e) {
                            t = t.getBBox();
                            n._drawGridLines({
                                i: e,
                                x1: t.x + t.width / 2,
                            ...
                            for (var r = 0; r < e + (h.globals.isXNumeric ? 0 : 1); r++) 0 === r && 1 === e && 1 === h.globals.dataPoints && (s = i = h.globals.gridWidth / 2), n._drawGridLines({
                                i: r,
                                x1: i,
                                y1: a,
                                x2: s,
            ...
            value: function(t) {
                ...
                if (i.config.grid.xaxis.lines.show || i.config.xaxis.axisTicks.show)
                    ...
                    }), new g(this.ctx).drawXaxisTicks(s, 0, this.elg), a = s = s + i.globals.gridWidth / e + .3;
        ...
        f = (t(Ee, [{
            ...
            value: function(t, e) {
                var i = 2 < arguments.length && void 0 !== arguments[2] ? arguments[2] : 10,
                    ...
                    o = this.w,
                    r = Math.abs(e - t);
                if ("dataPoints" === (i = this._adjustTicksForSmallRange(i, a, r)) && (i = o.globals.dataPoints - 1), t === Number.MIN_VALUE && 0 === e || !X.isNumber(t) && !X.isNumber(e) || t === Number.MIN_VALUE && e === -Number.MAX_VALUE) return e = i, this.linearScale(t = 0, e, i);
            ...
            value: function(t, e, i) {
                var a = t;
                return void 0 !== e && this.w.config.yaxis[e].labels.formatter && void 0 === this.w.config.yaxis[e].tickAmount && (e = this.w.config.yaxis[e].labels.formatter(1), X.isNumber(Number(e)) && !X.isFloat(e) && (a = Math.ceil(i))), a < t ? a : t
            }
        }, {
            ...
            value: function(t, e, i) {
                ...
                o.logarithmic && r <= 5 && (a.invalidLogScale = !0), o.logarithmic && 5 < r ? (a.allSeriesCollapsed = !1, a.yAxisScale[t] = this.logarithmicScale(e, i, o.logBase), a.yAxisScale[t] = o.forceNiceScale ? this.logarithmicScaleNice(e, i, o.logBase) : this.logarithmicScale(e, i, o.logBase)) : i !== -Number.MAX_VALUE && X.isNumber(i) ? (a.allSeriesCollapsed = !1, void 0 === o.min && void 0 === o.max || o.forceNiceScale ? (s = void 0 === s.yaxis[t].max && void 0 === s.yaxis[t].min || s.yaxis[t].forceNiceScale, a.yAxisScale[t] = this.niceScale(e, i, o.tickAmount || (r < 5 && 1 < r ? r + 1 : 5), t, s)) : a.yAxisScale[t] = this.linearScale(e, i, o.tickAmount, t)) : a.yAxisScale[t] = this.linearScale(0, 5, 5)
            }
        }, {
            key: "setXScale",
            value: function(t, e) {
                var i = this.w,
                    ...
                    i = i.config.xaxis,
                    s = Math.abs(e - t);
                return e !== -Number.MAX_VALUE && X.isNumber(e) ? a.xAxisScale = this.linearScale(t, e, i.tickAmount || (s < 5 && 1 < s ? s + 1 : 5), 0) : a.xAxisScale = this.linearScale(0, 5, 5), a.xAxisScale
            }
        }, {
            ...
            value: function(t) {
                ...
                for (var d = t; d < a; d++) {
                    ...
                    for (var g = 0; g < o.series[d].length; g++) {
                        ...
                        }), X.isFloat(u) && (u = X.noExponents(u), o.yValueDecimal = Math.max(o.yValueDecimal, u.toString().split(".")[1].length)), n > h[d][g] && h[d][g] < 0 && (n = h[d][g])) : o.hasNullValues = !0
                    }
                }
            ...
            value: function() {
                ...
                if (e.isXNumeric)
                    for (var s = 0; s < e.series.length; s++)
                        if (e.labels[s])
                            for (var o = 0; o < e.labels[s].length; o++) null !== e.labels[s][o] && X.isNumber(e.labels[s][o]) && (e.maxX = Math.max(e.maxX, e.labels[s][o]), e.initialMaxX = Math.max(e.maxX, e.labels[s][o]), e.minX = Math.min(e.minX, e.labels[s][o]), e.initialMinX = Math.min(e.minX, e.labels[s][o]));
            ...
            value: function() {
                ...
                if (t.series.length)
                    for (var a = 0; a < t.series[t.maxValsInArrayIndex].length; a++)
                        for (var s = 0, o = 0, r = 0; r < t.series.length; r++) null !== t.series[r][a] && X.isNumber(t.series[r][a]) && (0 < t.series[r][a] ? s = s + parseFloat(t.series[r][a]) + 1e-4 : o += parseFloat(t.series[r][a])), r === t.series.length - 1 && (e.push(s), i.push(o));
        ...
        xt = (t(ze, [{
            ...
            value: function(t) {
                ...
                if (!this.axesUtils.isYAxisHidden(t)) {
                    ...
                    if (i.config.yaxis[t].labels.show)
                        for (var v = p; 0 <= v; v--) g = d = g = d = c = void 0, c = m[h = v], c = b(c, h, i), d = i.config.yaxis[t].labels.padding, i.config.yaxis[t].opposite && 0 !== i.config.yaxis.length && (d *= -1), g = e.axesUtils.getYAxisForeColor(s.colors, t), d = a.drawText({
                            x: d,
                        ...
                        }), h === p && (y = d), u.add(d), (g = document.createElementNS(i.globals.SVGNS, "title")).textContent = Array.isArray(c) ? c.join(" ") : c, d.node.appendChild(g), 0 !== i.config.yaxis[t].labels.rotate && (h = a.rotateAroundCenter(y.node), c = a.rotateAroundCenter(d.node), d.node.setAttribute("transform", "rotate(".concat(i.config.yaxis[t].labels.rotate, " ").concat(h.x, " ").concat(c.y, ")"))), x += f;
                    void 0 !== i.config.yaxis[t].title.text && (A = a.group({
                        class: "apexcharts-yaxis-title"
                    }), k = 0, i.config.yaxis[t].opposite && (k = i.globals.translateYAxisX[t]), k = a.drawText({
                        x: k,
                    ...
                    var w, k = i.config.yaxis[t].axisBorder,
                        A = 31 + k.offsetX;
                    i.config.yaxis[t].opposite && (A = -31 - k.offsetX), k.show && (w = a.drawLine(A, i.globals.translateY + k.offsetY - 2, A, i.globals.gridHeight + i.globals.translateY + k.offsetY + 2, k.color, 0, k.width), l.add(w)), i.config.yaxis[t].axisTicks.show && this.axesUtils.drawYAxisTicks(A, p, k, i.config.yaxis[t].axisTicks, t, f, l)
                }
                return l
            }
        }, {
            ...
            value: function(t) {
                ...
                s.show && (e = 0, "bar" === i.config.chart.type && i.globals.isXNumeric && (e -= 15), a = a.drawLine(i.globals.padHorizontal + e + s.offsetX, this.xAxisoffX, i.globals.gridWidth, this.xAxisoffX, s.color, 0, s.height), t.add(a))
            }
        }, {
            ...
            value: function() {
                ...
                (t = X.listToArray(t)).forEach(function(t, e) {
                    ...
                    s && void 0 !== s.labels.align && (i = o.globals.dom.baseEl.querySelector(".apexcharts-yaxis[rel='".concat(e, "'] .apexcharts-yaxis-texts-g")), e = o.globals.dom.baseEl.querySelectorAll(".apexcharts-yaxis[rel='".concat(e, "'] .apexcharts-yaxis-label")), e = X.listToArray(e), a = i.getBoundingClientRect(), "left" === s.labels.align ? (e.forEach(function(t, e) {
        ...
        vt = (t(Pe, [{
            ...
            value: function() {
                ...
                t.config.xaxis.crosshairs.show && ("gradient" === o && (f = e.drawGradient("vertical", r, n, l, h, null, a, null)), o = e.drawRect(), 1 === t.config.xaxis.crosshairs.width && (o = e.drawLine()), r = t.globals.gridHeight, (!X.isNumber(r) || r < 0) && (r = 0), n = t.config.xaxis.crosshairs.width, (!X.isNumber(n) || n < 0) && (n = 0), o.attr({
        ...
        wt = (t(Le, [{
            ...
            value: function(t) {
                ...
                0 !== i.responsive.length && ((s = i.responsive.slice()).sort(function(t, e) {
                    ...
                    if (e < i) {
                        e = T.extendArrayProps(o, n.globals.initialConfig, n), t = X.extend(e, t);
                        t = X.extend(n.config, t), r.overrideResponsiveOptions(t)
                    } else
                        for (var a = 0; a < s.length; a++) i < s[a].breakpoint && (t = T.extendArrayProps(o, s[a].options, n), t = X.extend(n.config, t), r.overrideResponsiveOptions(t))
                }, t ? (e = T.extendArrayProps(o, t, n), e = X.extend(n.config, e), i(e = X.extend(e, t))) : i({}))
            }
        }, {
        ...
        At = (t(Se, [{
            ...
            value: function(t) {
                var e = this.w,
                    ...
                    s = i.offsetY,
                    o = "middle";
                "left" === i.align ? (a = 10, o = "start") : "right" === i.align && (a = e.globals.svgWidth - 10, o = "end"), a += i.offsetX, s = s + parseInt(i.style.fontSize, 10) + i.margin / 2, void 0 !== i.text && ((a = new E(this.ctx).drawText({
                    x: a,
                    y: s,
                    text: i.text,
                    textAnchor: o,
        ...
        St = (t(Ae, [{
            ...
            value: function() {
                var t = this.w,
                    ...
                    i = (t.config.legend.height || "top" !== t.config.legend.position && "bottom" !== t.config.legend.position || (e.style.maxHeight = t.globals.svgHeight / 2 + "px"), Object.assign({}, X.getBoundingClientRect(e)));
            ...
            value: function(t, e) {
                ...
                }), a = Math.max.apply(Math, b(i)), t = e[i.indexOf(a)]), t
            }
        }]), Ae),
        Ct = (t(ke, [{
            ...
            value: function() {
                ...
                return n.config.xaxis.convertedCatToNumeric && 0 === l.length && (l = n.globals.categoryLabels), 0 < n.globals.timescaleLabels.length ? (t = {
                    ...
                    return t.length > e.length ? t : e
                }, 0)), o = e, e = (r = new gt(this.dCtx.ctx)).xLabelFormat(s, e, o, {
                    i: void 0,
                    ...
                    dateFormatter: new v(this.dCtx.ctx).formatDate,
                    w: n
                }), (n.config.xaxis.convertedCatToNumeric && void 0 === e || "" === String(e).trim()) && (i = e = "1"), s = r = (a = new E(this.dCtx.ctx)).getTextRects(e, n.config.xaxis.labels.style.fontSize), e !== i && (s = a.getTextRects(i, n.config.xaxis.labels.style.fontSize)), (t = {
            ...
            value: function() {
                ...
                return r.globals.hasGroups ? (t = (null == (t = r.config.xaxis.group.style) ? void 0 : t.fontSize) || r.config.xaxis.labels.style.fontSize, i = r.globals.groups.map(function(t) {
                    return t.title
                }), e = X.getLargestStringFromArr(i), i = this.dCtx.dimHelpers.getLargestStringFromMultiArr(e, i), o = s = (a = new E(this.dCtx.ctx)).getTextRects(e, t), e !== i && (o = a.getTextRects(i, t)), e = {
            ...
            value: function() {
                var t = this.w,
                    e = 0,
                    i = 0;
                return void 0 !== t.config.xaxis.title.text && (e = (t = new E(this.dCtx.ctx).getTextRects(t.config.xaxis.title.text, t.config.xaxis.title.style.fontSize)).width, i = t.height), {
                    width: e,
                    height: i
                }
            }
            ...
            value: function() {
                ...
                return 1.05 * (i = new E(this.dCtx.ctx).getTextRects(i, t.config.xaxis.labels.style.fontSize)).width * e.length > t.globals.gridWidth && 0 !== t.config.xaxis.labels.rotate && (t.globals.overlappingXLabels = !0), i
            }
        }, {
        ...
        Lt = (t(we, [{
            ...
            value: function() {
                ...
                return h.config.yaxis.map(function(t, e) {
                    ...
                    !g.isYAxisHidden(e) && t.labels.show && void 0 !== t.labels.minWidth && (n = t.labels.minWidth), !g.isYAxisHidden(e) && t.labels.show && r.result.length ? (a = h.globals.yLabelFormatters[e], s = r.niceMin === Number.MIN_VALUE ? 0 : r.niceMin, void 0 !== (i = r = a(s = String(s).length > String(r.niceMax).length ? s : r.niceMax, {
                        ...
                        dataPointIndex: -1,
                        w: h
                    })) && 0 !== r.length || (r = s), h.globals.isBarHorizontal && (d = 0, s = h.globals.labels.slice(), r = a(r = X.getLargestStringFromArr(s), {
                        seriesIndex: e,
                        dataPointIndex: -1,
                        w: h
                    }), i = l.dCtx.dimHelpers.getLargestStringFromMultiArr(r, s)), a = new E(l.dCtx.ctx), e = "rotate(".concat(t.labels.rotate, " 0 0)"), o = s = a.getTextRects(r, t.labels.style.fontSize, t.labels.style.fontFamily, e, !1), r !== i && (o = a.getTextRects(i, t.labels.style.fontSize, t.labels.style.fontFamily, e, !1)), c.push({
            ...
            value: function() {
                ...
                return t.config.yaxis.map(function(t, e) {
                    var i, a;
                    t.show && void 0 !== t.title.text ? (a = new E(s.dCtx.ctx), i = "rotate(".concat(t.title.rotate, " 0 0)"), a = a.getTextRects(t.title.text, t.title.style.fontSize, t.title.style.fontFamily, i, !1), o.push({
                        width: a.width,
                        height: a.height
                    })) : o.push({
                        width: 0,
        ...
        Tt = (t(ye, [{
            ...
            value: function() {
                ...
                this.dimGrid.setGridXPosForDualYAxis(o, s), new xt(this.ctx).setYAxisXPosition(s, o)
            }
        }, {
        ...
        Mt = (t(me, [{
            ...
            value: function(t, e) {
                ...
                o.globals.axisCharts || "radialBar" === o.config.chart.type ? (o.globals.resized = !0, i = a = null, o.globals.risingSeries = [], i = o.globals.axisCharts ? (a = o.globals.dom.baseEl.querySelector(".apexcharts-series[data\\:realIndex='".concat(t, "']")), parseInt(a.getAttribute("data:realIndex"), 10)) : (a = o.globals.dom.baseEl.querySelector(".apexcharts-series[rel='".concat(t + 1, "']")), parseInt(a.getAttribute("rel"), 10) - 1), e ? [{
                    ...
                    seriesEl: a,
                    realIndex: i
                })) : (e = o.globals.dom.Paper.select(" .apexcharts-series[rel='".concat(t + 1, "'] path")), "pie" !== (a = o.config.chart.type) && "polarArea" !== a && "donut" !== a || (t = o.config.plotOptions.pie.donut.labels, new E(this.lgCtx.ctx).pathMouseDown(e.members[0], null), this.lgCtx.ctx.pie.printDataLabelsInner(e.members[0].node, t)), e.fire("click"))
            }
        }, {
            key: "hideSeries",
            value: function(t) {
        ...
        It = (t(be, [{
            ...
            value: function() {
                ...
                if ((t.legend.showForSingleSeries && 1 === e.series.length || this.isBarsDistributed || 1 < e.series.length || !e.axisCharts) && t.legend.show) {
                    ...
                    this.drawLegends(), X.isIE11() ? document.getElementsByTagName("head")[0].appendChild(this.legendHelpers.getLegendStyles()) : this.legendHelpers.appendToForeignObject(), "bottom" === t.legend.position || "top" === t.legend.position ? this.legendAlignHorizontal() : "right" !== t.legend.position && "left" !== t.legend.position || this.legendAlignVertical()
                }
            }
        }, {
            key: "drawLegends",
            value: function() {
                ...
                for (var o = e.globals.legendFormatter, r = e.config.legend.inverseOrder, n = r ? a.length - 1 : 0; r ? 0 <= n : n <= a.length - 1; r ? n-- : n++) {
                    ...
                    var u = document.createElement("span"),
                        ...
                        w = u.style,
                        x = (w.background = s[n], w.color = s[n], w.setProperty("background", s[n], "important"), e.config.legend.markers.fillColors && e.config.legend.markers.fillColors[n] && (w.background = e.config.legend.markers.fillColors[n]), void 0 !== e.globals.seriesColors[n] && (w.background = e.globals.seriesColors[n], w.color = e.globals.seriesColors[n]), w.height = Array.isArray(x) ? parseFloat(x[n]) + "px" : parseFloat(x) + "px", w.width = Array.isArray(b) ? parseFloat(b[n]) + "px" : parseFloat(b) + "px", w.left = (Array.isArray(p) ? parseFloat(p[n]) : parseFloat(p)) + "px", w.top = (Array.isArray(f) ? parseFloat(f[n]) : parseFloat(f)) + "px", w.borderWidth = Array.isArray(m) ? m[n] : m, w.borderColor = Array.isArray(y) ? y[n] : y, w.borderRadius = Array.isArray(v) ? parseFloat(v[n]) + "px" : parseFloat(v) + "px", e.config.legend.markers.customHTML && (Array.isArray(e.config.legend.markers.customHTML) ? e.config.legend.markers.customHTML[n] && (u.innerHTML = e.config.legend.markers.customHTML[n]()) : u.innerHTML = e.config.legend.markers.customHTML()), E.setAttrs(u, {
                            rel: n + 1,
                            "data:collapsed": h || c
            ...
            value: function(t) {
                ...
                "heatmap" === e.config.chart.type || this.isBarsDistributed ? i && (e = parseInt(t.target.getAttribute("rel"), 10) - 1, this.ctx.events.fireEvent("legendHover", [this.ctx, e, this.w]), new m(this.ctx).highlightRangeInSeries(t, t.target)) : !t.target.classList.contains("apexcharts-inactive-legend") && i && new m(this.ctx).toggleSeriesOnHover(t, t.target)
            }
        }, {
            key: "onLegendClick",
            value: function(t) {
        ...
        zt = (t(xe, [{
            ...
            value: function() {
                ...
                for (var h = 0; h < n.length; h++) E.setAttrs(n[h].el, {
                    class: n[h].class,
                    title: n[h].title
            ...
            value: function(t) {
                this.elMenuItems = [], t.appendChild(this.elMenu), E.setAttrs(this.elMenu, {
                ...
                for (var i = 0; i < e.length; i++) this.elMenuItems.push(document.createElement("div")), this.elMenuItems[i].innerHTML = e[i].title, E.setAttrs(this.elMenuItems[i], {
            ...
            value: function(t, e) {
                ...
                }, i = X.clone(a.globals.initialConfig.yaxis), a.config.chart.zoom.autoScaleYaxis && (i = new f(this.ctx).autoScaleY(this.ctx, i, {
                    xaxis: t
            ...
            value: function(t) {
                this.ctx.getSyncedCharts().forEach(function(t) {
                    var e = t.w,
                        ...
                        }), e.globals.zoomed = !1, t.ctx.series.emptyCollapsedSeries(X.clone(e.globals.initialSeries)));
        ...
        Xt = (e(x, zt), ot = i(x), t(x, [{
            ...
            value: function(t) {
                ...
                }), E.setAttrs(n.node, o)), r.globals.selectionEnabled && (l.attr({
                    x: e,
                    y: i,
                    width: 0 < a ? a : 0,
                    height: 0 < s ? s : 0,
            ...
            value: function(t) {
                ...
                r.config.yaxis.forEach(function(t, e) {
                ...
                }), n.dragged && (10 < n.dragX || 10 < n.dragY) && h !== c && (r.globals.zoomEnabled ? (i = X.clone(r.globals.initialConfig.yaxis), e = X.clone(r.globals.initialConfig.xaxis), r.globals.zoomed = !0, r.config.xaxis.convertedCatToNumeric && (h = Math.floor(h), c = Math.floor(c), h < 1 && (h = 1, c = r.globals.dataPoints), c - h < 2 && (c = h + 1)), "xy" !== t && "x" !== t || (e = {
                    min: h,
                    max: c
                }), "xy" !== t && "y" !== t || i.forEach(function(t, e) {
                    i[e].min = g[e], i[e].max = d[e]
                }), r.config.chart.zoom.autoScaleYaxis && (i = new f(n.ctx).autoScaleY(n.ctx, i, {
                    xaxis: e
                    ...
                    min: h,
                    max: c
                }, "xy" !== t && "y" !== t || (a = X.clone(r.config.yaxis)).forEach(function(t, e) {
            ...
            value: function(t, e) {
                var i = this.w,
                    ...
                    o = (i.config.chart.zoom.autoScaleYaxis && (s = new f(this.ctx).autoScaleY(this.ctx, s, {
                        xaxis: a
                    })), {
                        xaxis: {
                            min: t,
        ...
        Yt = (t(pe, [{
            ...
            value: function(t) {
                ...
                for (var i = 0, a = g.globals.series.length - 1; i < g.globals.series.length; i++, a--) ! function(t, e) {
                    ...
                    })))), null === l && (o = i.yLbFormatter(g.globals.series[n], P(P({}, g), {}, {
                        seriesIndex: n,
                        dataPointIndex: n
                    }))), r.DOMHandling({
                        i: n,
            ...
            value: function(t) {
                var e = t.i,
                    ...
                    s = i.globals.isXNumeric && "datetime" === i.config.xaxis.type ? new gt(this.ctx).xLabelFormat(i.globals.ttKeyFormatter, a, a, {
                        i: void 0,
                        dateFormatter: new v(this.ctx).formatDate,
                        w: this.w
        ...
        Ft = (t(ue, [{
            ...
            value: function(t) {
                var e = this.ttCtx;
                null !== e.ycrosshairs && E.setAttrs(e.ycrosshairs, {
                    y1: t,
                    y2: t
                }), null !== e.ycrosshairsHidden && E.setAttrs(e.ycrosshairsHidden, {
                    y1: t,
                    y2: t
                })
            }
            ...
            value: function(t) {
                var e = this.ttCtx,
                    ...
                    r = new m(this.ctx).getActiveConfigSeriesIndex("asc", ["line", "area", "scatter", "bubble"]),
                ...
                this.moveXCrosshairs(a), e.fixedTooltip || (r = s || i.globals.gridHeight, this.moveTooltip(a, r, n))
            }
        }, {
            ...
            value: function(t) {
                var e = this.w,
                    ...
                    s = (e.globals.isBarHorizontal && (s = new m(this.ctx).getActiveConfigSeriesIndex("desc") + 1), e.globals.dom.baseEl.querySelector(".apexcharts-bar-series .apexcharts-series[rel='".concat(s, "'] path[j='").concat(t, "'], .apexcharts-candlestick-series .apexcharts-series[rel='").concat(s, "'] path[j='").concat(t, "'], .apexcharts-boxPlot-series .apexcharts-series[rel='").concat(s, "'] path[j='").concat(t, "'], .apexcharts-rangebar-series .apexcharts-series[rel='").concat(s, "'] path[j='").concat(t, "']"))),
                ...
                e.globals.isXNumeric ? (s && !c && (o -= a % 2 != 0 ? n / 2 : 0), s && c && e.globals.comboCharts && (o -= n / 2)) : e.globals.isBarHorizontal || (o = i.xAxisTicksPositions[t - 1] + i.dataPointsDividedWidth / 2, isNaN(o) && (o = i.xAxisTicksPositions[t] - i.dataPointsDividedWidth / 2)), e.globals.isBarHorizontal ? (r > e.globals.gridHeight / 2 && (r -= i.tooltipRect.ttHeight), (r = r + e.config.grid.padding.top + l / 3) + l > e.globals.gridHeight && (r = e.globals.gridHeight - l)) : e.config.tooltip.followCursor ? r = i.e.clientY - h.top - i.tooltipRect.ttHeight / 2 : r + i.tooltipRect.ttHeight + 15 > e.globals.gridHeight && (r = e.globals.gridHeight), r < -10 && (r = -10), e.globals.isBarHorizontal || this.moveXCrosshairs(o), i.fixedTooltip || (a = r || e.globals.gridHeight, this.moveTooltip(o, a))
            }
        }]), ue),
        Rt = (t(ge, [{
            ...
            value: function() {
                var t = this.w,
                    e = new E(this.ctx),
                    i = new w(this.ctx),
                    a = b(a = t.globals.dom.baseEl.querySelectorAll(".apexcharts-series"));
            ...
            value: function() {
                for (var t = this.w.globals.dom.baseEl.querySelectorAll(".apexcharts-series:not(.apexcharts-series-collapsed) .apexcharts-marker"), e = 0; e < t.length; e++) {
                    ...
                    X.isNumber(i) && 0 <= i ? t[e].setAttribute("r", i) : t[e].setAttribute("r", 0)
                }
            }
        }]), ge),
        Dt = (t(de, [{
            ...
            value: function(t) {
                var e, i = t.e,
                    ...
                    c = i.barHeight,
                    d = i.j,
                    i = (a.globals.capturedSeriesIndex = h, a.globals.capturedDataPointIndex = d, a.globals.isBarHorizontal && s.tooltipUtil.hasBars() || !a.config.tooltip.shared ? (n = i.x, l = i.y, e = Array.isArray(a.config.stroke.width) ? a.config.stroke.width[h] : a.config.stroke.width, r = n) : a.globals.comboCharts || a.config.tooltip.shared || (r /= 2), isNaN(l) ? l = a.globals.svgHeight - s.tooltipRect.ttHeight : l < 0 && (l = 0), parseInt(t.paths.parentNode.getAttribute("data:realIndex"), 10)),
                    t = a.globals.isMultipleYAxis ? a.config.yaxis[i] && a.config.yaxis[i].reversed : a.config.yaxis[0].reversed;
                n + s.tooltipRect.ttWidth > a.globals.gridWidth && !t ? n -= s.tooltipRect.ttWidth : n < 0 && (n = 0), s.w.config.tooltip.followCursor && (i = s.getElGrid().getBoundingClientRect(), l = s.e.clientY - i.top), null === s.tooltip && (s.tooltip = a.globals.dom.baseEl.querySelector(".apexcharts-tooltip")), a.config.tooltip.shared || (0 < a.globals.comboBarCount ? s.tooltipPosition.moveXCrosshairs(r + e / 2) : s.tooltipPosition.moveXCrosshairs(r)), !s.fixedTooltip && (!a.config.tooltip.shared || a.globals.isBarHorizontal && s.tooltipUtil.hasBars()) && (t && (n -= s.tooltipRect.ttWidth) < 0 && (n = 0), !t || a.globals.isBarHorizontal && s.tooltipUtil.hasBars() || (l = l + c - 2 * (a.globals.series[h][d] < 0 ? c : 0)), s.tooltipRect.ttHeight + l > a.globals.gridHeight ? l = a.globals.gridHeight - s.tooltipRect.ttHeight + a.globals.translateY : (l = l + a.globals.translateY - s.tooltipRect.ttHeight / 2) < 0 && (l = 0), o.style.left = n + a.globals.translateX + "px", o.style.top = l + "px")
            }
        }, {
            key: "getBarTooltipXY",
            value: function(t) {
                var e, i, a, s, o, r, n, l, h = t.e,
                    t = t.opt,
                    c = this.w,
                    d = null,
                    g = this.ttCtx,
        ...
        Nt = (t(he, [{
            ...
            value: function(t) {
                ...
                }, i.e = t, !i.tooltipUtil.hasBars() || s.globals.comboCharts || i.isBarShared || this.tConfig.onDatasetHover.highlightDataSeries && new m(e).toggleSeriesOnHover(t, t.target.parentNode), i.fixedTooltip && i.drawFixedTooltipRect(), s.globals.axisCharts ? i.axisChartsTooltips({
                    e: t,
                    opt: a,
            ...
            value: function(t, e, i, a) {
                ...
                e.hoverX < 0 || e.hoverX > r.width ? this.handleMouseOut(a) : null !== o ? this.handleStickyCapturedSeries(t, o, a, i) : (this.tooltipUtil.isXoverlap(i) || s.globals.isBarHorizontal) && this.create(t, this, 0, i, a.ttItems)
            }
        }, {
            ...
            value: function(t, e, i, a, s) {
                ...
                if (o) {
                    if (e.tooltipLabels.drawSeriesTexts({
                            ttItems: s,
                            i: i,
                            j: a,
                            shared: !this.showOnIntersect && this.tConfig.shared
                        }), t && (0 < r.globals.markers.largestSize ? e.marker.enlargePoints(a) : e.tooltipPosition.moveDynamicPointsOnHover(a)), this.tooltipUtil.hasBars() && (this.barSeriesHeight = this.tooltipUtil.getBarsHeight(n), 0 < this.barSeriesHeight)) {
                ...
                } else e.tooltipLabels.drawSeriesTexts({
                    shared: !1,
                    ttItems: s,
                    i: i,
                    j: a
                }), this.tooltipUtil.hasBars() && e.tooltipPosition.moveStickyTooltipOverBars(a), t && e.tooltipPosition.moveMarkers(i, a)
            }
        }]), he),
        Ot = (t(le, [{
            ...
            value: function(t) {
                var e = t.x,
                    ...
                    f = Array.isArray(this.barCtx.strokeWidth) ? this.barCtx.strokeWidth[n] : this.barCtx.strokeWidth,
                    x = e + parseFloat(c * g),
                    b = i + parseFloat(h * g);
                u.globals.isXNumeric && !u.globals.isBarHorizontal && (x = e + parseFloat(c * (g + 1)), b = i + parseFloat(h * (g + 1)) - f);
                var g = null,
                    m = e,
                    y = i,
                    ...
                    d = (void 0 !== d && this.barCtx.isRangeBar && (y = b = d), v.offsetX),
                    A = v.offsetY,
                    S = {
                        width: 0,
                        height: 0
                    },
                    p = (u.config.dataLabels.enabled && (C = this.barCtx.series[o][r], S = p.getTextRects(u.globals.yLabelFormatters[0](C), parseFloat(v.style.fontSize))), {
                        x: e,
                        y: i,
                        i: o,
                        j: r,
                    ...
                    C = this.barCtx.isHorizontal ? this.calculateBarsDataLabelsPosition(p) : this.calculateColumnsDataLabelsPosition(p);
                return t.attr({
                    cy: C.bcy,
                    cx: C.bcx,
                    j: r,
                    ...
                    totalDataLabels: g = u.config.chart.stacked && k.enabled ? this.drawTotalDataLabels({
            ...
            value: function(t) {
                ...
                return a = this.totalFormatter ? this.totalFormatter(a, P(P({}, i), {}, {
                    seriesIndex: e,
                    dataPointIndex: t,
                    w: i
                })) : a
            ...
            value: function(t) {
                var e, i, a = this.w,
                    ...
                    m = t.offY,
                    c = Math.abs(c),
                    y = "vertical" === a.config.plotOptions.bar.dataLabels.orientation,
                    t = (l -= x / 2, a.globals.gridWidth / a.globals.dataPoints),
                    t = a.globals.isXNumeric ? l - h / 2 + b : l - t + h / 2 + b,
                    v = (y && (t = t + d.height / 2 - x / 2 - 2), this.barCtx.series[s][o] < 0),
                    w = n;
                switch (this.barCtx.isReversed && (w = n - c + (v ? 2 * c : 0), n -= c), p.position) {
                    case "center":
                        g = y ? v ? w + c / 2 + m : w + c / 2 - m : v ? w - c / 2 + d.height / 2 + m : w + c / 2 + d.height / 2 - m;
                        break;
                    case "bottom":
                        g = y ? v ? w + c + m : w + c - m : v ? w - c + d.height + x + m : w + c - d.height / 2 + x - m;
                        break;
                    case "top":
                        g = y ? v ? w + m : w - m : v ? w - d.height / 2 - m : w + d.height + m
                }
                return this.barCtx.lastActiveBarSerieIndex === r && f.enabled && (h = new E(this.barCtx.ctx).getTextRects(this.getStackedTotalDataLabel({
                    realIndex: r,
                    j: o
                }), u.fontSize), e = v ? w - h.height / 2 - m - f.offsetY + 18 : w + h.height + m + f.offsetY - 18, i = t + f.offsetX), a.config.chart.stacked || (g < 0 ? g = 0 + x : g + d.height / 3 > a.globals.gridHeight && (g = a.globals.gridHeight - x)), {
                    bcx: l,
                    bcy: n,
                    dataLabelsX: t,
                    dataLabelsY: g,
            ...
            value: function(t) {
                var e, i, a = this.w,
                    ...
                    c = Math.abs(c),
                    m = l - (this.barCtx.isRangeBar ? 0 : m) + h / 2 + d.height / 2 + t - 3,
                    h = "start",
                    y = this.barCtx.series[o][r] < 0,
                    v = s;
                switch (this.barCtx.isReversed && (v = s + c - (y ? 2 * c : 0), s = a.globals.gridWidth - c), f.position) {
                    case "center":
                        g = y ? v + c / 2 - b : Math.max(d.width / 2, v - c / 2) + b;
                        break;
                    case "bottom":
                        g = y ? v + c - u - Math.round(d.width / 2) - b : v - c + u + Math.round(d.width / 2) + b;
                        break;
                    case "top":
                        g = y ? v - u + Math.round(d.width / 2) - b : v - u - Math.round(d.width / 2) + b
                }
                return this.barCtx.lastActiveBarSerieIndex === n && x.enabled && (t = new E(this.barCtx.ctx).getTextRects(this.getStackedTotalDataLabel({
                    realIndex: n,
                    j: r
                }), p.fontSize), y ? (e = v - u + Math.round(t.width / 2) - b - x.offsetX - 15, h = "end") : e = v - u - Math.round(t.width / 2) + b + x.offsetX + 15, i = m + x.offsetY), a.config.chart.stacked || (g < 0 ? g = g + d.width + u : g + d.width / 2 > a.globals.gridWidth && (g = a.globals.gridWidth - d.width - u)), {
                    bcx: s,
                    bcy: l,
                    dataLabelsX: g,
                    dataLabelsY: m,
        ...
        Wt = (t(ne, [{
            ...
            value: function(t) {
                var e = t.barWidth,
                    ...
                    r = (r = Array.isArray(r) ? r[l] : r) || 0,
                    a = this.getRoundedBars(t, {
                        barWidth: e,
                        strokeWidth: r,
                        yRatio: a,
                        barXPosition: i,
                    ...
                    e = d.move(o, s),
                    g = d.line(n - r, s);
                return 0 < t.globals.previousPaths.length && (e = this.barCtx.getPreviousPath(l, c, !1)), i = i + d.line(o, a.y2) + a.pathWithRadius + d.line(n - r, a.y2) + g + g + "z", e = e + d.line(o, s) + g + g + g + g + g + d.line(o, s), t.config.chart.stacked && (this.barCtx.yArrj.push(a.y2WithRadius), this.barCtx.yArrjF.push(Math.abs(s - a.y2WithRadius)), this.barCtx.yArrjVal.push(this.barCtx.series[h][c])), {
                    pathTo: i,
                    pathFrom: e
                }
            }
            ...
            value: function(t) {
                var e = t.barYPosition,
                    ...
                    r = c.move(a, e),
                    d = c.move(a, e),
                    n = (0 < t.globals.previousPaths.length && (d = this.barCtx.getPreviousPath(n, h, !1)), e),
                    e = e + i,
                    i = c.line(a, e - o),
                    r = r + c.line(s.x2, n) + s.pathWithRadius + c.line(s.x2, e - o) + i + i + "z",
                    d = d + c.line(a, n) + i + i + i + i + i + c.line(a, n);
                return t.config.chart.stacked && (this.barCtx.xArrj.push(s.x2WithRadius), this.barCtx.xArrjF.push(Math.abs(a - s.x2WithRadius)), this.barCtx.xArrjVal.push(this.barCtx.series[l][h])), {
                    pathTo: r,
                    pathFrom: d
                }
            }
            ...
            key: "getRoundedBars",
            value: function(t, e, i, a, s) {
                var o = new E(this.barCtx.ctx),
                    r = 0,
                    n = t.config.plotOptions.bar.borderRadius,
                    l = Array.isArray(n),
                    r = l ? n[a > n.length - 1 ? n.length - 1 : a] : n;
                return t.config.chart.stacked && 1 < i.length && a !== this.barCtx.radiusOnSeriesNumber && !l && (r = 0), this.barCtx.isHorizontal ? (n = "", t = e.x2, Math.abs(e.x1 - e.x2) < r && (r = Math.abs(e.x1 - e.x2)), void 0 === i[a][s] && null === i[a][s] || ((l = this.barCtx.isReversed ? 0 < i[a][s] : i[a][s] < 0) && (r *= -1), n = o.quadraticCurve((t -= r) + r, e.barYPosition, t + r, e.barYPosition + (l ? -1 * r : r)) + o.line(t + r, e.barYPosition + e.barHeight - e.strokeWidth - (l ? -1 * r : r)) + o.quadraticCurve(t + r, e.barYPosition + e.barHeight - e.strokeWidth, t, e.barYPosition + e.barHeight - e.strokeWidth)), {
                    pathWithRadius: n,
                    x2WithRadius: t + r,
                    x2: t
                }) : (l = "", n = e.y2, Math.abs(e.y1 - e.y2) < r && (r = Math.abs(e.y1 - e.y2)), void 0 === i[a][s] && null === i[a][s] || ((t = i[a][s] < 0) && (r *= -1), l = o.quadraticCurve(e.barXPosition, (n += r) - r, e.barXPosition + (t ? -1 * r : r), n - r) + o.line(e.barXPosition + e.barWidth - e.strokeWidth - (t ? -1 * r : r), n - r) + o.quadraticCurve(e.barXPosition + e.barWidth - e.strokeWidth, n - r, e.barXPosition + e.barWidth - e.strokeWidth, n)), {
                    pathWithRadius: l,
                    y2WithRadius: n - r,
                    y2: n
                })
        ...
        M = (t(re, [{
                ...
                for (var r = 0, n = 0; r < t.length; r++, n++) {
                    ...
                    for (var w = a.group({
                        ...
                        var S = this.barHelpers.getStrokeWidth(r, A, g),
                            ...
                            L = (this.isHorizontal ? (C = this.drawBarPaths(P(P({}, L), {}, {
                                barHeight: p,
                                zeroW: m,
                                yDivision: b
                            })), f = this.series[r][A] / this.invertedYRatio) : (C = this.drawColumnPaths(P(P({}, L), {}, {
                                xDivision: y,
                                barWidth: f,
                                zeroH: v
                            })), p = this.series[r][A] / this.yRatio[this.yaxisIndex]), this.barHelpers.drawGoalLine({
                            ...
                            L = (L && k.add(L), h = C.y, l = C.x, 0 < A && d.push(l + f / 2), c.push(h), this.barHelpers.getPathFillColor(t, r, A, g));
                        this.renderSeries({
                            realIndex: g,
                            pathFill: L,
                            j: A,
            ...
            value: function(t) {
                var e = t.realIndex,
                    ...
                    A = (w.config.series[o].data[s] && w.config.series[o].data[s].strokeColor && (a = w.config.series[o].data[s].strokeColor), this.isNullValue && (i = "none"), s / w.config.chart.animations.animateGradually.delay * (w.config.chart.animations.speed / w.globals.dataPoints) / 2.4),
                    k = k.renderPaths({
                        i: o,
                        j: s,
                        realIndex: e,
                ...
                return null !== n.dataLabels && m.add(n.dataLabels), n.totalDataLabels && m.add(n.totalDataLabels), h.add(m), y && h.add(y), h
            }
        }, {
            key: "drawBarPaths",
            value: function(t) {
                var e = t.indexes,
                    ...
                    l = e.i,
                    h = e.j,
                    c = (o = n.globals.isXNumeric ? (n.globals.seriesX[l][h] - n.globals.minX) / this.invertedXRatio - i : o) + i * this.visibleI,
                ...
                return n.globals.isXNumeric || (o += r), this.barHelpers.barBackground({
                    j: h,
                    i: l,
            ...
            value: function(t) {
                var e = t.indexes,
                    ...
                    c = e.j,
                    d = e.bc,
                    l = (n.globals.isXNumeric && (n.globals.seriesX[l = l].length || (l = n.globals.maxValsInArrayIndex), i = (n.globals.seriesX[l][c] - n.globals.minX) / this.xRatio - s * this.seriesLen / 2), i + s * this.visibleI),
                ...
                return n.globals.isXNumeric || (i += a), this.barHelpers.barBackground({
                    bc: d,
                    j: c,
                    i: h,
        ...
        Bt = (e(u, M), st = i(u), t(u, [{
            ...
            value: function(y, v) {
                var w = this,
                    k = this.w,
                    t = (this.graphics = new E(this.ctx), this.bar = new M(this.ctx, this.xyRatios), new T(this.ctx, k));
                y = t.getLogSeries(y), this.yRatio = t.getLogYRatios(this.yRatio), this.barHelpers.initVariables(y), "100%" === k.config.chart.stackType && (y = k.globals.seriesPercent.slice()), this.series = y, this.totalItems = 0, this.prevY = [], this.prevX = [], this.prevYF = [], this.prevXF = [], this.prevYVal = [], this.prevXVal = [], this.xArrj = [], this.xArrjF = [], this.xArrjVal = [], this.yArrj = [], this.yArrjF = [], this.yArrjVal = [];
                for (var e = 0; e < y.length; e++) 0 < y[e].length && (this.totalItems += y[e].length);
                for (var A = this.graphics.group({
                        class: "apexcharts-bar-series apexcharts-plot-series"
                    }), S = 0, C = 0, i = 0, a = 0; i < y.length; i++, a++) ! function(t, e) {
                    var i, a, s, o, r = [],
                        n = [],
                        l = k.globals.comboCharts ? v[t] : t,
                        h = (1 < w.yRatio.length && (w.yaxisIndex = l), w.isReversed = k.config.yaxis[w.yaxisIndex] && k.config.yaxis[w.yaxisIndex].reversed, w.graphics.group({
                            class: "apexcharts-series",
                            seriesName: X.escapeString(k.globals.seriesNames[l]),
                            rel: t + 1,
                            "data:realIndex": l
                        })),
                        c = (w.ctx.series.addCollapsedClassToSeries(h, l), w.graphics.group({
                            class: "apexcharts-datalabels",
                            "data:realIndex": l
                        })),
                        d = w.graphics.group({
                    ...
                    C = p.y, g = p.barHeight, a = p.yDivision, o = p.zeroW, S = p.x, u = p.barWidth, i = p.xDivision, s = p.zeroH, w.yArrj = [], w.yArrjF = [], w.yArrjVal = [], w.xArrj = [], w.xArrjF = [], w.xArrjVal = [], 1 === w.prevY.length && w.prevY[0].every(function(t) {
                        return isNaN(t)
                    ...
                    for (var f = 0; f < k.globals.dataPoints; f++) var x = w.barHelpers.getStrokeWidth(t, f, l),
                        b = {
                            indexes: {
                                i: t,
                                j: f,
                        ...
                        m = null,
                        b = (w.isHorizontal ? (m = w.drawStackedBarPaths(P(P({}, b), {}, {
                            zeroW: o,
                            barHeight: g,
                            yDivision: a
                        })), u = w.series[t][f] / w.invertedYRatio) : (m = w.drawStackedColumnPaths(P(P({}, b), {}, {
                            xDivision: i,
                            barWidth: u,
                            zeroH: s
                        })), g = w.series[t][f] / w.yRatio[w.yaxisIndex]), w.barHelpers.drawGoalLine({
                        ...
                        b = (b && d.add(b), C = m.y, S = m.x, r.push(S), n.push(C), w.barHelpers.getPathFillColor(y, t, f, l)),
                        h = w.renderSeries({
                            realIndex: l,
                            pathFill: b,
                            j: f,
                    ...
                    k.globals.seriesXvalues[l] = r, k.globals.seriesYvalues[l] = n, w.prevY.push(w.yArrj), w.prevYF.push(w.yArrjF), w.prevYVal.push(w.yArrjVal), w.prevX.push(w.xArrj), w.prevXF.push(w.xArrjF), w.prevXVal.push(w.xArrjVal), A.add(h)
                }(i, a);
                return A
            }
        }, {
            ...
            value: function(t, e, i, a, s, o) {
                var r, n, l = this.w;
                return this.isHorizontal ? (r = (r = a = l.globals.gridHeight / l.globals.dataPoints) * parseInt(l.config.plotOptions.bar.barHeight, 10) / 100, o = this.baseLineInvertedY + l.globals.padHorizontal + (this.isReversed ? l.globals.gridWidth : 0) - (this.isReversed ? 2 * this.baseLineInvertedY : 0), e = (a - r) / 2) : (n = i = l.globals.gridWidth / l.globals.dataPoints, n = l.globals.isXNumeric && 1 < l.globals.dataPoints ? (i = l.globals.minXDiff / this.xRatio) * parseInt(this.barOptions.columnWidth, 10) / 100 : n * parseInt(l.config.plotOptions.bar.columnWidth, 10) / 100, s = l.globals.gridHeight - this.baseLineY[this.yaxisIndex] + (this.isReversed ? l.globals.gridHeight : 0) - (this.isReversed ? 2 * this.baseLineY[this.yaxisIndex] : 0), t = l.globals.padHorizontal + (i - n) / 2), {
                    x: t,
                    y: e,
                    yDivision: a,
                    xDivision: i,
            ...
            value: function(t) {
                for (var e = t.indexes, i = t.barHeight, a = t.strokeWidth, s = t.zeroW, o = (t.x, t.y), r = t.yDivision, t = t.elSeries, n = this.w, l = o, h = e.i, c = e.j, d = 0, g = 0; g < this.prevXF.length; g++) d += this.prevXF[g][c];
                var u = 0 < h ? (u = s, this.prevXVal[h - 1][c] < 0 ? u = 0 <= this.series[h][c] ? this.prevX[h - 1][c] + d - 2 * (this.isReversed ? d : 0) : this.prevX[h - 1][c] : 0 <= this.prevXVal[h - 1][c] && (u = 0 <= this.series[h][c] ? this.prevX[h - 1][c] : this.prevX[h - 1][c] - d + 2 * (this.isReversed ? d : 0)), u) : s,
                    p = null === this.series[h][c] ? u : u + this.series[h][c] / this.invertedYRatio - 2 * (this.isReversed ? this.series[h][c] / this.invertedYRatio : 0),
            ...
            value: function(t) {
                for (var e = t.indexes, i = t.x, a = (t.y, t.xDivision), s = t.barWidth, o = t.zeroH, t = (t.strokeWidth, t.elSeries), r = this.w, n = e.i, l = e.j, h = e.bc, c = i = r.globals.isXNumeric ? ((r.globals.seriesX[n][l] || 0) - r.globals.minX) / this.xRatio - s / 2 : i, d = 0, g = 0; g < this.prevYF.length; g++) d += isNaN(this.prevYF[g][l]) ? 0 : this.prevYF[g][l];
                if (0 < n && !r.globals.isXNumeric || 0 < n && r.globals.isXNumeric && r.globals.seriesX[n - 1][l] === r.globals.seriesX[n][l]) {
                    var u, p, f = Math.min(this.yRatio.length + 1, n + 1);
                    ...
                    for (var b = 1; b < f; b++) {
                        if (this.prevYVal[n - b][l] < 0) {
                            u = 0 <= this.series[n][l] ? p - d + 2 * (this.isReversed ? d : 0) : p;
                            break
                        }
                        if (0 <= this.prevYVal[n - b][l]) {
                            u = 0 <= this.series[n][l] ? p : p + d - 2 * (this.isReversed ? d : 0);
                            break
                        }
                    }
                    void 0 === u && (u = r.globals.gridHeight), y = this.prevYF[0].every(function(t) {
                        return 0 === t
                ...
                var m = y - this.series[n][l] / this.yRatio[this.yaxisIndex] + 2 * (this.isReversed ? this.series[n][l] / this.yRatio[this.yaxisIndex] : 0),
        ...
        Vt = (e(c, M), at = i(c), t(c, [{
            ...
            value: function(m, s) {
                var y = this,
                    ...
                    o = new E(this.ctx),
                    w = new C(this.ctx),
                    t = (this.candlestickOptions = this.w.config.plotOptions.candlestick, this.boxOptions = this.w.config.plotOptions.boxPlot, this.isHorizontal = v.config.plotOptions.bar.horizontal, new T(this.ctx, v));
                m = t.getLogSeries(m), this.series = m, this.yRatio = t.getLogYRatios(this.yRatio), this.barHelpers.initVariables(m);
                for (var k = o.group({
                        class: "apexcharts-".concat(v.config.chart.type, "-series apexcharts-plot-series")
                    }), e = 0; e < m.length; e++) ! function(r) {
                    ...
                    for (var b = o.group({
                        ...
                        var s = y.barHelpers.getStrokeWidth(r, a, h),
                            ...
                            o = y.isHorizontal ? y.drawHorizontalBoxPaths(P(P({}, t), {}, {
                                yDivision: g,
                                barHeight: d,
                                zeroW: u
                            })) : y.drawVerticalBoxPaths(P(P({}, t), {}, {
                                xDivision: f,
                                barWidth: p,
                                zeroH: x
                            }));
        ...
        Gt = (t(oe, [{
            ...
            value: function(t, e, i, a) {
                var s = this.w,
                    ...
                    a = new X;
                return {
                    color: i = s.config.plotOptions[t].enableShades ? "dark" === this.w.config.theme.mode ? X.hexToRgba(a.shadeColor(-1 * o, e.color), s.config.fill.opacity) : X.hexToRgba(a.shadeColor(o, e.color), s.config.fill.opacity) : i,
                    colorProps: e
                }
            }
        }, {
        ...
        Ut = (t(ie, [{
                ...
                for (var h = 0; h < t.length; h++) {
                    var c, d, g = s.group({
                        ...
                        p = (f.attr({
                            index: 0,
                            j: h
                        }), a.setSelectionFilter(f, 0, h), i.config.chart.dropShadow.enabled && (p = i.config.chart.dropShadow, a.dropShadow(f, p, h)), this.addListeners(f, this.donutDataLabels), E.setAttrs(f.node, {
                            "data:angle": u,
                            "data:startAngle": c,
                        ...
                        g = ("pie" === this.chartType || "polarArea" === this.chartType ? p = X.polarToCartesian(this.centerX, this.centerY, i.globals.radialSize / 1.25 + i.config.plotOptions.pie.dataLabels.offset, (c + u / 2) % this.fullAngle) : "donut" === this.chartType && (p = X.polarToCartesian(this.centerX, this.centerY, (i.globals.radialSize + this.donutSize) / 2 + i.config.plotOptions.pie.dataLabels.offset, (c + u / 2) % this.fullAngle)), g.add(f), 0);
            ...
            value: function(i) {
                ...
                if (0 !== o.strokeWidth) {
                    for (var e = [], r = 360 / t.globals.series.length, n = 0; n < t.globals.series.length; n++) e.push(X.polarToCartesian(this.centerX, this.centerY, t.globals.radialSize, t.config.plotOptions.pie.startAngle + r * n));
        ...
        qt = (t(ee, [{
            ...
            value: function(t) {
                ...
                return this.yaxisLabels = this.graphics.group({
                    ...
                    for (var n = 0; n < i.linePathsTo.length; n++) {
                        var l, h, c = u.graphics.renderPaths(P(P({}, a), {}, {
                            ...
                            c = u.graphics.renderPaths(P(P({}, a), {}, {
                        ...
                        p.config.chart.dropShadow.enabled && (l = new S(u.ctx), h = p.config.chart.dropShadow, l.dropShadow(c, Object.assign({}, h, {
                            noUserSpaceOnUse: !0
                        }), s)), o.add(c)
                    }
                    t.forEach(function(t, e) {
            ...
            key: "drawPolygons",
            value: function(t) {
                for (var o = this, s = this.w, r = t.parent, i = new _t(this.ctx), a = s.globals.yAxisScale[0].result.reverse(), e = a.length, n = [], l = this.size / (e - 1), h = 0; h < e; h++) n[h] = l * h;
                n.reverse();
                var c = [],
                    d = [];
            ...
            value: function(t) {
                for (var e = this.w, i = new E(this.ctx), a = new C(this.ctx), s = new S(this.ctx), o = i.group(), r = this.getStrokeWidth(t), n = (t.size = t.size - r / 2, e.config.plotOptions.radialBar.hollow.background), l = t.size - r * t.series.length - this.margin * t.series.length - r * parseInt(e.config.plotOptions.radialBar.track.strokeWidth, 10) / 100 / 2, h = l - e.config.plotOptions.radialBar.hollow.margin, h = (void 0 !== e.config.plotOptions.radialBar.hollow.image && (n = this.drawHollowImage(t, o, l, n)), this.drawHollow({
                    ...
                    var u = i.group({
                        ...
                        m = void 0,
                        y = (e.globals.dataChanged && (x = this.startAngle, m = Math.round(this.totalAngle * X.negToZero(e.globals.previousPaths[g]) / 100) + x), 360 <= Math.abs(b) + Math.abs(f) && (b -= .01), 360 <= Math.abs(m) + Math.abs(x) && (m -= .01), b - f),
        ...
        $t = (e(n, M), et = i(n), t(n, [{
            ...
            value: function(t, e) {
                ...
                for (var s = a.group({
                    ...
                    for (var r = void 0, n = void 0, l = i.globals.comboCharts ? e[o] : o, h = a.group({
                            class: "apexcharts-series",
                            seriesName: X.escapeString(i.globals.seriesNames[l]),
                            rel: o + 1,
                            "data:realIndex": l
                        }), c = (this.ctx.series.addCollapsedClassToSeries(h, l), 0 < t[o].length && (this.visibleI = this.visibleI + 1), 0), d = 0, g = (1 < this.yRatio.length && (this.yaxisIndex = l), this.barHelpers.initialPositions()), n = g.y, u = g.zeroW, r = g.x, d = g.barWidth, p = g.xDivision, f = g.zeroH, x = a.group({
                            class: "apexcharts-datalabels",
                            "data:realIndex": l
                        }), b = a.group({
                        ...
                        if (c = g.barHeight, this.isHorizontal) {
                            ...
                            i.config.series[o].data[m].x && (c = (L = this.detectOverlappingBars({
                                i: o,
                                j: m,
                                barYPosition: A,
                                srty: L,
                                ...
                                yDivision: C,
                                initPositions: g
                            })).barHeight, A = L.barYPosition), d = (k = this.drawRangeBarPaths(P({
                                indexes: {
                                    i: o,
                                    j: m,
                                    realIndex: l
                        ...
                        } else c = (k = this.drawRangeColumnPaths(P({
                            indexes: {
                                i: o,
                                j: m,
                                realIndex: l
                        ...
                        L = this.barHelpers.drawGoalLine({
                            ...
                            barHeight: c,
                            barWidth: d
                        }), C = (L && b.add(L), n = k.y, r = k.x, this.barHelpers.getPathFillColor(t, o, m, l)), S = i.globals.stroke.colors[l];
                        this.renderSeries({
                            realIndex: l,
                            pathFill: C,
                            lineFill: S,
            ...
            value: function(t) {
                var e = t.i,
                    ...
                    a = n.config.plotOptions.bar.rangeBarGroupRows ? s + r * i : s + o * this.visibleI + r * i;
                return {
                    barYPosition: a = -1 < d && !n.config.plotOptions.bar.rangeBarOverlap && -1 < (l = n.globals.seriesRange[e][d].overlaps).indexOf(h) ? (o = t.barHeight / l.length) * this.visibleI + r * (100 - parseInt(this.barOptions.barHeight, 10)) / 100 / 2 + o * (this.visibleI + l.indexOf(h)) + r * i : a,
                    barHeight: o
                }
            }
        }, {
            ...
            value: function(t) {
                var e = t.indexes,
                    ...
                    g = (i = o.globals.isXNumeric ? (o.globals.seriesX[r][n] - o.globals.minX) / this.xRatio - s / 2 : i) + s * this.visibleI,
                    l = (void 0 === this.series[r][n] || null === this.series[r][n] ? d = t : (d = t - d / l, c = t - c / l), Math.abs(c - d)),
        ...
        Jt = (t(te, [{
            ...
            value: function(t, e) {
                var i = this.w;
                return "gradient" !== i.config.fill.type && "gradient" !== i.config.fill.type[t] || !new T(this.lineCtx.ctx, i).seriesHaveSameValues(t) || ((i = e[t].slice())[i.length - 1] = i[i.length - 1] + 1e-6, e[t] = i), e
            }
        }, {
            key: "calculatePoints",
            value: function(t) {
        ...
        Qt = (t(Kt, [{
            ...
            value: function(t, e, i, a) {
                ...
                for (var l = [], h = 0; h < t.length; h++) {
                    ...
                    this.ctx.series.addCollapsedClassToSeries(this.elSeries, c), s.globals.isXNumeric && 0 < s.globals.seriesX.length && (u = (s.globals.seriesX[c][0] - s.globals.minX) / this.xRatio), g.push(u);
                    var p, f = u,
                        x = void 0,
                        b = f,
                        m = this.zeroY,
                        ...
                        u = (d.push(m), p = m, "rangeArea" === r && (x = y = this.lineHelpers.determineFirstPrevY({
                            i: h,
                            series: a,
                            prevY: y,
                            lineYPosition: 0
                        ...
                        f = this._iterateOverDataPoints(P(P({}, u), {}, {
                            iterations: "rangeArea" === r ? t[h].length - 1 : void 0,
                            isRangeStart: !0
                        }));
                    "rangeArea" === r && (p = this._calculatePathsFrom({
                        series: a,
                        i: h,
                        realIndex: c,
                        prevX: b,
                        prevY: y
                    }), m = this._iterateOverDataPoints(P(P({}, u), {}, {
                        series: a,
                        pY: x,
                        pathsFrom: p,
                        iterations: a[h].length - 1,
                        isRangeStart: !1
                    })), f.linePaths[0] = m.linePath + f.linePath, f.pathFromLine = m.pathFromLine + f.pathFromLine), this._handlePaths({
                        type: r,
                        realIndex: c,
                        i: h,
                        paths: f
            ...
            value: function(t) {
                for (var e = t.type, i = t.series, a = t.iterations, s = t.realIndex, o = t.i, r = t.x, n = t.y, l = t.pX, h = t.pY, c = t.pathsFrom, d = t.linePaths, g = t.areaPaths, u = t.seriesIndex, p = t.lineYPosition, f = t.xArrj, x = t.yArrj, b = t.isRangeStart, m = t.seriesRangeEnd, y = this.w, v = new E(this.ctx), w = this.yRatio, k = c.prevY, A = c.linePath, S = c.areaPath, C = c.pathFromLine, L = c.pathFromArea, P = X.isNumber(y.globals.minYArr[s]) ? y.globals.minYArr[s] : y.globals.minY, a = a || (1 < y.globals.dataPoints ? y.globals.dataPoints - 1 : y.globals.dataPoints), T = n, M = 0; M < a; M++) {
                    var I = void 0 === i[o][M + 1] || null === i[o][M + 1],
                        z = (y.globals.isXNumeric ? (z = y.globals.seriesX[s][M + 1], r = ((z = void 0 === y.globals.seriesX[s][M + 1] ? y.globals.seriesX[s][a - 1] : z) - y.globals.minX) / this.xRatio) : r += this.xDivision, p = y.config.chart.stacked && 0 < o && y.globals.collapsedSeries.length < y.config.series.length - 1 ? this.prevSeriesY[function(t) {
                            ...
                            return 0 <= e ? e : 0
                        }(o - 1)][M + 1] : this.zeroY, I ? n = p - P / w[this.yaxisIndex] + 2 * (this.isReversed ? P / w[this.yaxisIndex] : 0) : (n = p - i[o][M + 1] / w[this.yaxisIndex] + 2 * (this.isReversed ? i[o][M + 1] / w[this.yaxisIndex] : 0), "rangeArea" === e && (T = p - m[o][M + 1] / w[this.yaxisIndex] + 2 * (this.isReversed ? m[o][M + 1] / w[this.yaxisIndex] : 0))), f.push(r), x.push(n), this.lineHelpers.calculatePoints({
                            series: i,
                            x: r,
                            y: n,
                            realIndex: s,
                        ...
                        S = I.areaPath,
                        A = I.linePath;
                    this.appendPathFrom && (C += v.line(r, this.zeroY), L += v.line(r, this.zeroY)), this.handleNullDataPoints(i, z, o, M, s), this._handleMarkersAndLabels({
                        type: e,
                        pointsPos: z,
                        i: o,
                        j: M,
    ...
    function Kt(t, e, i) {
        a(this, Kt), this.ctx = t, this.w = t.w, this.xyRatios = e, this.pointsChart = !("bubble" !== this.w.config.chart.type && "scatter" !== this.w.config.chart.type) || i, this.scatter = new ct(this.ctx), this.noNegatives = this.w.globals.minX === Number.MAX_VALUE, this.lineHelpers = new Jt(this), this.markers = new w(this.ctx), this.prevSeriesY = [], this.categoryAxisCorrection = 0, this.yaxisIndex = 0
    }
    ...
    function h(t) {
        a(this, h), (e = it.call(this, t)).ctx = t, e.w = t.w, e.animBeginArr = [0], e.animDur = 0;
        var e, t = e.w;
    ...
    function se(t, e) {
        a(this, se), this.ctx = t, this.w = t.w, this.xRatio = e.xRatio, this.yRatio = e.yRatio, this.dynamicAnim = this.w.config.chart.animations.dynamicAnimation, this.helpers = new Gt(t), this.rectRadius = this.w.config.plotOptions.heatmap.radius, this.strokeWidth = this.w.config.stroke.show ? this.w.config.stroke.width : 0
    }
    ...
    function re(t, e) {
        ...
        var t = this.w,
            t = (this.barOptions = t.config.plotOptions.bar, this.isHorizontal = this.barOptions.horizontal, this.strokeWidth = t.config.stroke.width, this.isNullValue = !1, this.isRangeBar = t.globals.seriesRange.length && this.isHorizontal, this.xyRatios = e, null !== this.xyRatios && (this.xRatio = e.xRatio, this.initialXRatio = e.initialXRatio, this.yRatio = e.yRatio, this.invertedXRatio = e.invertedXRatio, this.invertedYRatio = e.invertedYRatio, this.baseLineY = e.baseLineY, this.baseLineInvertedY = e.baseLineInvertedY), this.yaxisIndex = 0, this.seriesLen = 0, new m(this.ctx)),
    ...
    function ge(t) {
        a(this, ge), this.w = t.w, this.ttCtx = t, this.ctx = t.ctx, this.tooltipPosition = new Ft(t)
    }
    ...
    function pe(t) {
        a(this, pe), this.w = t.w, this.ctx = t.ctx, this.ttCtx = t, this.tooltipUtil = new Et(t)
    }
    ...
    function x(t) {
        var e;
        return a(this, x), (e = ot.call(this, t)).ctx = t, e.w = t.w, e.dragged = !1, e.graphics = new E(e.ctx), e.eventList = ["mousedown", "mouseleave", "mousemove", "touchstart", "touchmove", "mouseup", "touchend"], e.clientX = 0, e.clientY = 0, e.startX = 0, e.endX = 0, e.dragX = 0, e.startY = 0, e.endY = 0, e.dragY = 0, e.moveDirection = "none", e
    }
    ...
    function be(t, e) {
        a(this, be), this.ctx = t, this.w = t.w, this.onLegendClick = this.onLegendClick.bind(this), this.onLegendHovered = this.onLegendHovered.bind(this), this.isBarsDistributed = "bar" === this.w.config.chart.type && this.w.config.plotOptions.bar.distributed && 1 === this.w.config.series.length, this.legendHelpers = new Mt(this)
    }
    ...
    function ye(t) {
        a(this, ye), this.ctx = t, this.w = t.w, this.lgRect = {}, this.yAxisWidth = 0, this.yAxisWidthLeft = 0, this.yAxisWidthRight = 0, this.xAxisHeight = 0, this.isSparkline = this.w.config.chart.sparkline.enabled, this.dimHelpers = new St(this), this.dimYAxis = new Lt(this), this.dimXAxis = new Ct(this), this.dimGrid = new Pt(this), this.lgWidthForSideLegends = 0, this.gridPad = this.w.config.grid.padding, this.xPadRight = 0, this.xPadLeft = 0
    }
    ...
    function Ie(t) {
        a(this, Ie), this.ctx = t, this.w = t.w, this.documentEvent = X.bind(this.documentEvent, this)
    }
    ...
    function Ye(t) {
        ...
        var e = this.w;
        this.xaxisLabels = e.globals.labels.slice(), this.axesUtils = new L(t), this.isRangeBar = e.globals.seriesRange.length, 0 < e.globals.timescaleLabels.length && (this.xaxisLabels = e.globals.timescaleLabels.slice())
    }
    ...
    function He(t) {
        a(this, He), this.ctx = t, this.w = t.w, this.tooltipKeyFormat = "dd MMM"
    }

    function Ne(t) {
        a(this, Ne), this.ctx = t, this.w = t.w, this.twoDSeries = [], this.threeDSeries = [], this.twoDSeriesX = [], this.seriesGoals = [], this.coreUtils = new T(this.ctx)
    }

    function Oe(t) {
        a(this, Oe), this.ctx = t, this.w = t.w, this.legendInactiveClass = "legend-mouseover-inactive"
    }
    ...
    function Ve(t, e) {
        a(this, Ve), this.ctx = t, this.w = t.w
    }

    function Ge(t) {
        a(this, Ge), this.ctx = t, this.w = t.w, this.opts = null, this.seriesIndex = 0
    }
    ...
    function Ze(t) {
        a(this, Ze), this.ctx = t, this.w = t.w, this.months31 = [1, 3, 5, 7, 8, 10, 12], this.months30 = [2, 4, 6, 9, 11], this.daysCntOfYear = [0, 31, 59, 90, 120, 151, 181, 212, 243, 273, 304, 334]
    }

    function $e(t) {
        a(this, $e), this.ctx = t, this.w = t.w, this.graphics = new E(this.ctx), this.w.globals.isBarHorizontal && (this.invertAxis = !0), this.helpers = new s(this), this.xAxisAnnotations = new B(this), this.yAxisAnnotations = new V(this), this.pointsAnnotations = new G(this), this.w.globals.isBarHorizontal && this.w.config.yaxis[0].reversed && (this.inversedReversedAxis = !0), this.xDivision = this.w.globals.gridWidth / this.w.globals.dataPoints
    }

    function Je() {
        a(this, Je), this.yAxis = {
            show: !0,
            showAlways: !1,
            showForNullSeries: !0,
            seriesName: void 0,
    ...
    function Qe(t, e, i, a) {
        this.xoffset = t, this.yoffset = e, this.height = a, this.width = i, this.shortestEdge = function() {
            ...
            var e, i;
            return this.width >= this.height ? (e = t / this.height, i = this.width - e, new Qe(this.xoffset + e, this.yoffset, i, this.height)) : (e = t / this.width, i = this.height - e, new Qe(this.xoffset, this.yoffset + e, this.width, i))
        }
    }
        ...
        for (var a, r = function t(e, i, a, s) {
                ...
                if (0 !== e.length) return r = a.shortestEdge(),
                    function(t, e, i) {
                        ...
                        e = ti(t, i), t = ti(a, i);
                        return t <= e
                    }(i, o = e[0], r) ? (i.push(o), t(e.slice(1), i, a, s)) : (r = a.cutArea(I(i), s), s.push(a.getCoordinates(i)), t(e, [], r, s)), s;
                s.push(a.getCoordinates(i))
            }(function(t) {
                for (var e = [], i = s * o / I(t), a = 0; a < t.length; a++) e[a] = t[a] * i;
                return e
            }(t), [], new Qe(e, i, s, o), []), n = [], l = 0; l < r.length; l++)
    ...
    window.TreemapSquared = {}, window.TreemapSquared.generate = function t(e, i, a, s, o) {
        ...
        if (ei(e[0])) {
            ...
            for (r = Ke(l, i, a, s, o), n = 0; n < e.length; n++) h.push(t(e[n], r[n][2] - r[n][0], r[n][3] - r[n][1], r[n][0], r[n][1]))
        } else h = Ke(e, i, a, s, o);
        return h
    };
    t(hi, [{
        ...
        value: function(u) {
            ...
            return f.globals.noData || (e = [], u.forEach(function(t) {
                ...
                var g = x.group({
                    ...
                    e = (f.config.chart.dropShadow.enabled && (e = f.config.chart.dropShadow, new S(p.ctx).dropShadow(i, e, d)), x.group({
                        class: "apexcharts-data-labels"
                    }));
                t.forEach(function(t, e) {
                    var i = t[0],
        ...
        value: function(t, e, i, a, s, o, r) {
            ...
            i.width + this.w.config.stroke.width + 5 > o - a && i.width <= r - s && (e = n.rotateAroundCenter(t.node), t.node.setAttribute("transform", "rotate(-90 ".concat(e.x, " ").concat(e.y, ")")))
        }
    }, {
        key: "animateTreemap",
        value: function(t, e, i, a) {
    ...
    var z, Y, ii = hi,
        ai = (t(li, [{
            ...
            value: function(t, e) {
                ...
                i.globals.timescaleLabels = t.slice(), new Tt(this.ctx).plotCoords()
            }
        }, {
            ...
            value: function(t) {
                var e, i = t.firstVal,
                    ...
                    c = "month",
                    d = 0;
                1 < i.minDate ? (l = (h.determineDaysOfMonths(s + 1, i.minYear) - a + 1) * r, t = X.monthMod(s + 1), i = o + d, a = X.monthMod(t), 0 === (e = t) && (c = "year", e = i, i += d += a = 1), this.timeScaleArray.push({
                    position: l,
                    value: e,
                    unit: c,
                    year: i,
                ...
                for (var g = t + 1, u = l, p = 0; p < n; p++, 0) {
                    0 === (g = X.monthMod(g)) ? (c = "year", d += 1) : c = "month";
            ...
            value: function(t) {
                ...
                var i = t.firstVal,
                    ...
                    d = t,
                    g = e(h, a, s);
                0 === i.minHour && 1 === i.minDate ? (c = 0, d = X.monthMod(i.minMonth), l = "month", h = i.minDate, r++) : 1 !== i.minDate && 0 === i.minHour && 0 === i.minMinute && (c = 0, t = i.minDate, g = e(h = d = t, a, s)), this.timeScaleArray.push({
                    position: c,
                    value: d,
                    unit: l,
        ...
        si = (t(ni, [{
            ...
            value: function(a, t) {
                ...
                if (r.comboCharts) 0 < l.series.length && y.push(i.draw(l.series, "area", l.i)), 0 < d.series.length && (s.config.chart.stacked ? (e = new Bt(this.ctx, t), y.push(e.draw(d.series, d.i))) : (this.ctx.bar = new M(this.ctx, t), y.push(this.ctx.bar.draw(d.series, d.i)))), 0 < f.series.length && y.push(i.draw(f.series, "rangeArea", f.i, f.seriesRangeEnd)), 0 < n.series.length && y.push(i.draw(n.series, "line", n.i)), 0 < g.series.length && y.push(x.draw(g.series, g.i)), 0 < u.series.length && y.push(x.draw(u.series, u.i)), 0 < p.series.length && y.push(this.ctx.rangeBar.draw(p.series, p.i)), 0 < h.series.length && (e = new Qt(this.ctx, t, !0), y.push(e.draw(h.series, "scatter", h.i))), 0 < c.series.length && (x = new Qt(this.ctx, t, !0), y.push(x.draw(c.series, "bubble", c.i)));
                    ...
                    case "area":
                        ...
                        break;
                    case "bar":
                        y = (o.chart.stacked ? new Bt(this.ctx, t) : (this.ctx.bar = new M(this.ctx, t), this.ctx.bar)).draw(r.series);
                        break;
                    case "candlestick":
                    case "boxPlot":
                        y = new Vt(this.ctx, t).draw(r.series);
                        break;
                    case "rangeBar":
            ...
            value: function() {
                var t = this.w.globals,
                    e = this.w.config,
                    i = (t.svgWidth = e.chart.width, t.svgHeight = e.chart.height, X.getDimensions(this.el)),
                    a = e.chart.width.toString().split(/[0-9]+/g).pop(),
                    i = ("%" === a ? X.isNumber(i[0]) && (0 === i[0].width && (i = X.getDimensions(this.el.parentNode)), t.svgWidth = i[0] * parseInt(e.chart.width, 10) / 100) : "px" !== a && "" !== a || (t.svgWidth = parseInt(e.chart.width, 10)), e.chart.height.toString().split(/[0-9]+/g).pop());
                "auto" !== t.svgHeight && "" !== t.svgHeight ? "%" === i ? (a = X.getDimensions(this.el.parentNode), t.svgHeight = a[1] * parseInt(e.chart.height, 10) / 100) : t.svgHeight = parseInt(e.chart.height, 10) : t.axisCharts ? t.svgHeight = t.svgWidth / 1.61 : t.svgHeight = t.svgWidth / 1.2, t.svgWidth < 0 && (t.svgWidth = 0), t.svgHeight < 0 && (t.svgHeight = 0), E.setAttrs(t.dom.Paper.node, {
                    width: t.svgWidth,
                    height: t.svgHeight
            ...
            value: function() {
                var t = this.w,
                    ...
                    s = (a += t.config.grid.padding.bottom, "top" !== t.config.legend.position && "bottom" !== t.config.legend.position || !t.config.legend.show || t.config.legend.floating || (i = new It(this.ctx).legendHelpers.getLegendBBox().clwh + 10), t.globals.dom.baseEl.querySelector(".apexcharts-radialbar, .apexcharts-pie")),
                    o = 2.05 * t.globals.radialSize,
                    s = (s && !t.config.chart.sparkline.enabled && 0 !== t.config.plotOptions.radialBar.startAngle && (o = (s = X.getBoundingClientRect(s)).bottom, s = s.bottom - s.top, o = Math.max(2.05 * t.globals.radialSize, s)), o + e.translateY + i + a);
                e.dom.elLegendForeign && e.dom.elLegendForeign.setAttribute("height", s), t.config.chart.height && 0 < String(t.config.chart.height).indexOf("%") || (e.dom.elWrap.style.height = s + "px", E.setAttrs(e.dom.Paper.node, {
                    height: s
                ...
                o.config.chart.brush.enabled && "function" != typeof o.config.chart.events.selection && ((i = o.config.chart.brush.targets || [o.config.chart.brush.target]).forEach(function(t) {
                    ...
                    i.forEach(function(t) {
                        var a = ApexCharts.getChartByID(t),
                            ...
                            t = (o.config.chart.brush.autoScaleYaxis && 1 === a.w.globals.series.length && (s = new f(a).autoScaleY(a, s, e)), a.w.config.yaxis.reduce(function(t, e, i) {
                                return [].concat(b(t), [P(P({}, a.w.config.yaxis[i]), {}, {
                                    min: s[0].min,
                                    max: s[0].max
                                })])
                            }, []));
        ...
        oi = (t(ri, [{
            ...
            value: function(a, s) {
                ...
                return new Promise(function(t) {
                    ...
                    return i.globals.shouldAnimate = s, i.globals.dataChanged = !0, s && o.ctx.series.getPreviousPaths(), i.globals.axisCharts ? (0 === (e = a.map(function(t, e) {
                        ...
                        data: []
                    }]), i.config.series = e) : i.config.series = a.slice(), r && (i.globals.initialConfig.series = X.clone(i.config.series), i.globals.initialSeries = X.clone(i.config.series)), o.ctx.update().then(function() {
                        t(o.ctx)
                    })
                })
            }
            ...
            value: function(t, e) {
                ...
                return i.globals.axisCharts ? a = i.globals.dom.Paper.select("".concat(s, " path[j='").concat(e, "'], ").concat(s, " circle[j='").concat(e, "'], ").concat(s, " rect[j='").concat(e, "']")).members[0] : void 0 === e && (a = i.globals.dom.Paper.select("".concat(s, " path[j='").concat(t, "']")).members[0], "pie" !== i.config.chart.type && "polarArea" !== i.config.chart.type && "donut" !== i.config.chart.type || this.ctx.pie.pieClicked(t)), a ? (new E(this.ctx).pathMouseDown(a, null), a.node || null) : (console.warn("toggleDataPointSelection: Element not found"), null)
            }
        }, {
    ...
    function li(t) {
        a(this, li), this.ctx = t, this.w = t.w, this.timeScaleArray = [], this.utc = this.w.config.xaxis.labels.datetimeUTC
    }

    function hi(t, e) {
        a(this, hi), this.ctx = t, this.w = t.w, this.strokeWidth = this.w.config.stroke.width, this.helpers = new Gt(t), this.dynamicAnim = this.w.config.chart.animations.dynamicAnimation, this.labels = []
    }
    ...
    z = "undefined" != typeof window ? window : void 0, Y = function(s, o) {
        ...
        }) : "object" === ("undefined" == typeof exports ? "undefined" : y(exports)) && "undefined" != typeof module ? module.exports = z.document ? Y(z, z.document) : function(t) {
        ...
        function() {
            ...
            morph: function(t) {
                for (var e = this.value, i = this.parse(t), a = 0, s = 0; !1 !== a || !1 !== s;) var o, r = ui(e, !1 !== a && a + 1),
                    n = ui(i, !1 !== s && s + 1),
                    l = (!1 === a && (a = 0 == (o = new SVG.PathArray(l.start).bbox()).height || 0 == o.width ? e.push(e[0]) - 1 : e.push(["M", o.x + o.width / 2, o.y + o.height / 2]) - 1), !1 === s && (s = 0 == (o = new SVG.PathArray(l.dest).bbox()).height || 0 == o.width ? i.push(i[0]) - 1 : i.push(["M", o.x + o.width / 2, o.y + o.height / 2]) - 1), function(t, e, i, a, s, o, r) {
                        for (var n = t.slice(e, i || r), l = a.slice(s, o || r), h = 0, c = {
                                ...
                                pos: [0, 0],
                                start: [0, 0]
                            }; n[h] = ci.call(c, n[h]), l[h] = ci.call(d, l[h]), n[h][0] != l[h][0] || "M" == n[h][0] || "A" == n[h][0] && (n[h][4] != l[h][4] || n[h][5] != l[h][5]) ? (Array.prototype.splice.apply(n, [h, 1].concat(gi.call(c, n[h]))), Array.prototype.splice.apply(l, [h, 1].concat(gi.call(d, l[h])))) : (n[h] = di.call(c, n[h]), l[h] = di.call(d, l[h])), ++h != n.length || h != l.length;) h == n.length && n.push(["C", c.pos[0], c.pos[1], c.pos[0], c.pos[1], c.pos[0], c.pos[1]]), h == l.length && l.push(["C", d.pos[0], d.pos[1], d.pos[0], d.pos[1], d.pos[0], d.pos[1]]);
                        return {
                            start: n,
                            dest: l
                        }
    ...
    t(mi, [{
        key: "initModules",
        value: function() {
            this.ctx.publicMethods = ["updateOptions", "updateSeries", "appendData", "appendSeries", "toggleSeries", "showSeries", "hideSeries", "setLocale", "resetSeries", "zoomX", "toggleDataPointSelection", "dataURI", "exportToCSV", "addXaxisAnnotation", "addYaxisAnnotation", "addPointAnnotation", "clearAnnotations", "removeAnnotation", "paper", "destroy"], this.ctx.eventList = ["click", "mousedown", "mousemove", "mouseleave", "touchstart", "touchmove", "touchleave", "mouseup", "touchend"], this.ctx.animations = new A(this.ctx), this.ctx.axes = new yt(this.ctx), this.ctx.core = new si(this.ctx.el, this.ctx), this.ctx.config = new p({}), this.ctx.data = new dt(this.ctx), this.ctx.grid = new pt(this.ctx), this.ctx.graphics = new E(this.ctx), this.ctx.coreUtils = new T(this.ctx), this.ctx.crosshairs = new vt(this.ctx), this.ctx.events = new bt(this.ctx), this.ctx.exports = new ut(this.ctx), this.ctx.localization = new mt(this.ctx), this.ctx.options = new d, this.ctx.responsive = new wt(this.ctx), this.ctx.series = new m(this.ctx), this.ctx.theme = new kt(this.ctx), this.ctx.formatters = new gt(this.ctx), this.ctx.titleSubtitle = new At(this.ctx), this.ctx.legend = new It(this.ctx), this.ctx.toolbar = new zt(this.ctx), this.ctx.tooltip = new Nt(this.ctx), this.ctx.dimensions = new Tt(this.ctx), this.ctx.updateHelpers = new oi(this.ctx), this.ctx.zoomPanSelection = new Xt(this.ctx), this.ctx.w.globals.tooltip = new Nt(this.ctx)
        }
    }]);
    var pi = mi,
        fi = (t(bi, [{
    ...
    return t(yi, [{
        ...
        value: function() {
            ...
            return new Promise(function(t, e) {
                ...
                null !== n && !h.globals.allSeriesCollapsed || l.series.handleNoData(), "treemap" !== h.config.chart.type && l.axes.drawAxis(h.config.chart.type, n.xyRatios), l.grid = new pt(l);
                var i, e = l.grid.drawGrid(),
                    a = (l.annotations = new nt(l), l.annotations.drawImageAnnos(), l.annotations.drawTextAnnos(), "back" === h.config.grid.position && e && h.globals.dom.elGraphical.add(e.el), new g(r.ctx)),
                    s = new xt(r.ctx);
                if (null !== e && (a.xAxisLabelCorrections(e.xAxisTickWidth), s.setYAxisTextAlignments(), h.config.yaxis.map(function(t, e) {
                        -1 === h.globals.ignoreYAxisIndexes.indexOf(e) && s.yAxisTitleRotate(e, t.opposite)
                    })), "back" === h.config.annotations.position && (h.globals.dom.Paper.add(h.globals.dom.elAnnotations), l.annotations.drawAxesAnnotations()), Array.isArray(n.elGraph))
                    for (var o = 0; o < n.elGraph.length; o++) h.globals.dom.elGraphical.add(n.elGraph[o]);
                else h.globals.dom.elGraphical.add(n.elGraph);
                "front" === h.config.grid.position && e && h.globals.dom.elGraphical.add(e.el), "front" === h.config.xaxis.crosshairs.position && l.crosshairs.drawXCrosshairs(), "front" === h.config.yaxis[0].crosshairs.position && l.crosshairs.drawYCrosshairs(), "front" === h.config.annotations.position && (h.globals.dom.Paper.add(h.globals.dom.elAnnotations), l.annotations.drawAxesAnnotations()), h.globals.noData || (h.config.tooltip.enabled && !h.globals.noData && l.w.globals.tooltip.drawTooltip(n.xyRatios), h.globals.axisCharts && (h.globals.isXNumeric || h.config.xaxis.convertedCatToNumeric || h.globals.isRangeBar) ? (h.config.chart.zoom.enabled || h.config.chart.selection && h.config.chart.selection.enabled || h.config.chart.pan && h.config.chart.pan.enabled) && l.zoomPanSelection.init({
                    xyRatios: n.xyRatios
                }) : (i = h.config.chart.toolbar.tools, ["zoom", "zoomin", "zoomout", "selection", "pan", "reset"].forEach(function(t) {
                    i[t] = !1
        ...
        key: "destroy",
        value: function() {
            window.removeEventListener("resize", this.windowResizeHandler), this.el.parentNode, t = this.parentResizeHandler, (e = xi.get(t)) && (e.disconnect(), xi.delete(t));
        ...
        value: function(t) {
            ...
            return this.w.config.series = i, e && (this.w.globals.initialSeries = X.clone(this.w.config.series)), this.update()
        }
    }, {
        key: "update",
        value: function(a) {
        ...
        key: "initOnLoad",
        value: function() {
            for (var t = document.querySelectorAll("[data-apexcharts]"), e = 0; e < t.length; e++) new yi(t[e], JSON.parse(t[e].getAttribute("data-options"))).render()
        }
    }, {
        key: "exec",
        value: function(t, e) {
