! function(e, t) {
    ...
    var e = function(M) {
            ...
            var e, d, _, o, R, f, B, F, w, l, c, x, T, n, k, p, i, r, g, C = "sizzle" + +new Date,
                u = M.document,
                A = 0,
                W = 0,
                z = N(),
            ...
            for (e in d = L.support = {}, R = L.isXML = function(e) {
                            ...
                            return 1 === g && 0 === m ? function(e) {
                                ...
                                if (u) {
                                    ...
                                    if (l = [y ? u.firstChild : u.lastChild], y && d) {
                                        for (f = (a = (i = (r = (o = (s = u)[C] || (s[C] = {}))[s.uniqueID] || (o[s.uniqueID] = {}))[p] || [])[0] === A && i[1]) && i[2], s = a && u.childNodes[a]; s = ++a && s && s[c] || (f = a = 0, l.pop());)
                                        ...
                                        for (;
                                            (s = ++a && s && s[c] || (f = a = 0, l.pop())) && ((b ? s.nodeName.toLowerCase() !== h : 1 !== s.nodeType) || !++f || (d && ((r = (o = s[C] || (s[C] = {}))[s.uniqueID] || (o[s.uniqueID] = {}))[p] = [A, f]), s !== e)););
                    ...
                    pseudos: {
                        ...
                        lang: O(function(n) {
                            return oe.test(n || "") || L.error("unsupported lang: " + n), n = n.replace(D, h).toLowerCase(),
                                function(e) {
                                    var t;
                                    do {
            ...
            function we(f, p, g, m, v, e) {
                return m && !m[C] && (m = we(m)), v && !v[C] && (v = we(v, e)), O(function(e, t, n, i) {
                    var r, o, s, a = [],
                        ...
                        d = g ? v || (e ? f : c || m) ? [] : t : h;
                    if (g && g(h, d, n, i), m)
                        for (r = _e(d, l), m(r, [], n, i), o = r.length; o--;)(s = r[o]) && (d[l[o]] = !(h[l[o]] = s));
                    if (e) {
                        if (v || f) {
                            if (v) {
                            ...
                            if (n = _.relative[t[l].type]) h = [ye(be(h), n)];
                                ...
                                if ((n = _.filter[t[l].type].apply(null, t[l].matches))[C]) {
                                    ...
                                    return we(1 < l && be(h), 1 < l && P(t.slice(0, l - 1).concat({
                                        value: " " === t[l - 2].type ? "*" : ""
                                    })).replace(v, "$1"), n, l < r && e(t.slice(l, r)), r < o && e(t = t.slice(r)), r < o && P(t))
                                }
                                h.push(n)
                            }
                        return be(h)
        ...
        o ? (_.set(e, r, !1), T.event.add(e, r, {
            ...
            handler: function(e) {
                ...
                if (1 & e.isTrigger && this[r]) {
                    ...
                    else if (i = a.call(arguments), _.set(this, r, i), t = o(this, r), this[r](), i !== (n = _.get(this, r)) || t ? _.set(this, r, !1) : n = {}, i !== n) return e.stopImmediatePropagation(), e.preventDefault(), n && n.value
                } else i.length && (_.set(this, r, {
    ...
    T.event = {
        ...
        add: function(t, e, n, i, r) {
            ...
            if (v(t))
                for (n.handler && (n = (o = n).handler, r = o.selector), r && T.find.matchesSelector(C, r), n.guid || (n.guid = T.guid++), a = (a = p.events) || (p.events = Object.create(null)), s = (s = p.handle) || (p.handle = function(e) {
    ...
    T.extend({
        ...
        clone: function(e, t, n) {
            ...
            if (!(m.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || T.isXMLDoc(e)))
                for (s = D(u), i = 0, r = (o = D(e)).length; i < r; i++) a = o[i], l = s[i], c = void 0, "input" === (c = l.nodeName.toLowerCase()) && we.test(a.type) ? l.checked = a.checked : "input" !== c && "textarea" !== c || (l.defaultValue = a.defaultValue);
            if (t)
                if (n)
                    for (o = o || D(e), s = s || D(u), i = 0, r = o.length; i < r; i++) He(o[i], s[i]);
                else He(e, u);
    ...
    var Fe, We, ze, $e, Ve, Xe, Ue, r, Ye = new RegExp("^(" + e + ")(?!px)[a-z%]+$", "i"),
        Qe = /^--/,
    ...
    function et(e, t, n) {
        var i, r = Qe.test(t),
            o = e.style;
        return (n = n || Re(e)) && (i = n.getPropertyValue(t) || n[t], "" !== (i = r ? i.replace(Ke, "$1") : i) || A(e) || (i = T.style(e, t)), !m.pixelBoxStyles() && Ye.test(i) && Ge.test(t) && (r = o.width, e = o.minWidth, t = o.maxWidth, o.minWidth = o.maxWidth = o.width = i, i = n.width, o.width = r, o.minWidth = e, o.maxWidth = t)), void 0 !== i ? i + "" : i
    }
    ...
    var N, dt, O, ft = /^(?:toggle|show|hide)$/,
        pt = /queueHooks$/;
    ...
    function j(r, e, t) {
        ...
        for (; u < h; u++)
            if (n = j.prefilters[u].call(p, r, g, p.opts)) return y(n.stop) && (T._queueHooks(p.elem, p.opts.queue).stop = n.stop.bind(n)), n;
    ...
    T.Animation = T.extend(j, {
        ...
        prefilters: [function(e, t, n) {
            ...
            if ((l = !T.isEmptyObject(t)) || !T.isEmptyObject(d))
                for (i in u && 1 === e.nodeType && (n.overflow = [f.overflow, f.overflowX, f.overflowY], null == (c = g && g.display) && (c = _.get(e, "display")), "none" === (u = T.css(e, "display")) && (c ? u = c : (E([e], !0), c = e.style.display || c, u = T.css(e, "display"), E([e]))), ("inline" === u || "inline-block" === u && null != c) && "none" === T.css(e, "float") && (l || (h.done(function() {
                        f.display = c
                    }), null == c && (u = f.display, c = "none" === u ? "" : u)), f.display = "inline-block")), n.overflow && (f.overflow = "hidden", h.always(function() {
                        f.overflow = n.overflow[0], f.overflowX = n.overflow[1], f.overflowY = n.overflow[2]
                    })), l = !1, d) l || (g ? "hidden" in g && (p = g.hidden) : g = _.access(e, "fxshow", {
                    display: c
                }), o && (g.hidden = !p), p && E([e], !0), h.done(function() {
        ...
        Et = (T.extend(T.event, {
            trigger: function(e, t, n, i) {
                ...
                if (3 !== n.nodeType && 8 !== n.nodeType && !At.test(d + T.event.triggered) && (-1 < d.indexOf(".") && (d = (f = d.split(".")).shift(), f.sort()), a = d.indexOf(":") < 0 && "on" + d, (e = e[T.expando] ? e : new T.Event(d, "object" == typeof e && e)).isTrigger = i ? 2 : 3, e.namespace = f.join("."), e.rnamespace = e.namespace ? new RegExp("(^|\\.)" + f.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, e.result = void 0, e.target || (e.target = n), t = null == t ? [e] : T.makeArray(t, [e]), c = T.event.special[d] || {}, i || !c.trigger || !1 !== c.trigger.apply(n, t))) {
                    ...
                    for (r = 0;
                        (p = h[r++]) && !e.isPropagationStopped();) u = p, e.type = 1 < r ? s : c.bindType || d, (l = (_.get(p, "events") || Object.create(null))[e.type] && _.get(p, "handle")) && l.apply(p, t), (l = a && p[a]) && l.apply && v(p) && (e.result = l.apply(p, t), !1 === e.result && e.preventDefault());
    ...
    zt.href = Et.href, T.extend({
        ...
        ajax: function(e, t) {
            ...
            var l, c, u, n, h, d, f, i, p = T.ajaxSetup({}, t = t || {}),
                g = p.context || p,
...
function(e, t) {
            ...
            p ? p.oneOff = p.oneOff && a : (p = te(t, r.replace(Y, "")), (r = e ? (h = i, d = o, f = t, function t(n) {
                ...
                for (let e = n["target"]; e && e !== this; e = e.parentNode)
                    for (const r of i)
                        if (r === e) return le(n, {
                            delegateTarget: e
                        }), t.oneOff && g.off(h, n.type, d, f), f.apply(e, [n])
    ...
    g.on(document, "click.bs.collapse.data-api", je, function(e) {
        ...
        e = R(this);
        for (const t of d.find(e)) Me.getOrCreateInstance(t, {
            toggle: !1
        }).toggle()
    }), e(Me);
    var E = "top",
    ...
    var gt = {
        ...
        fn: function(e) {
            ...
            a && l && (e = e.padding, n = o, n = ft("number" != typeof(e = "function" == typeof e ? e(Object.assign({}, n.rects, {
                placement: n.placement
            })) : e) ? e : pt(e, qe)), e = ot(a), r = "y" === c ? E : L, i = "y" === c ? S : D, t = o.rects.reference[u] + o.rects.reference[c] - l[c] - o.rects.popper[u], l = l[c] - o.rects.reference[c], a = (a = ct(a)) ? "y" === c ? a.clientHeight || 0 : a.clientWidth || 0 : 0, r = n[r], n = a - e[u] - n[i], r = ht(r, i = a / 2 - e[u] / 2 + (t / 2 - l / 2), n), o.modifiersData[s] = ((a = {})[c] = r, a.centerOffset = r - i, a))
        },
        effect: function(e) {
            var t = e.state;
    ...
    function Ot(n, e, t, i) {
        var r, o = "clippingParents" === e ? (s = Dt(at(o = n)), _(r = 0 <= ["absolute", "fixed"].indexOf(x(o).position) && w(o) ? ct(o) : o) ? s.filter(function(e) {
        ...
        fn: function(e) {
            var s = e.state,
                ...
                t = Ve.reduce(function(e, t) {
                    var n, i, r, o;
                    return e[t] = (t = t, n = s.rects, i = a, r = O(t), o = 0 <= [L, E].indexOf(r) ? -1 : 1, t = (n = "function" == typeof i ? i(Object.assign({}, n, {
                        placement: t
                    })) : i)[0] || 0, i = (n[1] || 0) * o, 0 <= [L, D].indexOf(r) ? {
                        x: i,
                        y: t
                    } : {
                        x: t,
    ...
    var Ut = Xt({
        defaultModifiers: [wt, Bt, bt, Ze, Rt, Pt, Ft, gt, qt]
    });
    ...
    class Dn extends t {
        ...
        show(e) {
            this._isShown || this._isTransitioning || g.trigger(this._element, kn, {
                relatedTarget: e
    ...
    class I extends t {
        ...
        show(e) {
            this._isShown || g.trigger(this._element, "show.bs.offcanvas", {
                relatedTarget: e
            }).defaultPrevented || (this._isShown = !0, this._backdrop.show(), this._config.scroll || (new dn).hide(), this._element.setAttribute("aria-modal", !0), this._element.setAttribute("role", "dialog"), this._element.classList.add(Ln), this._queueCallback(() => {
                this._config.scroll && !this._config.backdrop || this._focustrap.activate(), this._element.classList.add("show"), this._element.classList.remove(Ln), g.trigger(this._element, "shown.bs.offcanvas", {
                    relatedTarget: e
                })
            }, this._element, !0))
        }
    ...
    class Zn extends t {
        ...
        dispose() {
            clearTimeout(this._timeout), g.off(this._element.closest(".modal"), Un, this._hideModalHandler), this.tip && this.tip.remove(), this._element.getAttribute("data-bs-original-title") && this._element.setAttribute("title", this._element.getAttribute("data-bs-original-title")), this._disposePopper(), super.dispose()
        }
        show() {
            ...
            if (this._isWithContent() && this._isEnabled) {
                ...
                if (!e.defaultPrevented && t) {
                    ...
                    if (this._element.ownerDocument.documentElement.contains(this.tip) || (t.append(e), g.trigger(this._element, this.constructor.eventName("inserted"))), this._popper ? this._popper.update() : this._popper = this._createPopper(e), e.classList.add(Xn), "ontouchstart" in document.documentElement)
                        for (const n of [].concat(...document.body.children)) g.on(n, "mouseover", W);
                    this._queueCallback(() => {
        ...
        hide() {
            if (this._isShown()) {
                ...
                if (!e.defaultPrevented) {
                    ...
                    if (t.classList.remove(Xn), "ontouchstart" in document.documentElement)
                        for (const n of [].concat(...document.body.children)) g.off(n, "mouseover", W);
                    this._activeTrigger.click = !1, this._activeTrigger[Qn] = !1, this._activeTrigger[Yn] = !1, this._isHovered = null;
                    this._queueCallback(() => {
                        this._isWithActiveTrigger() || (this._isHovered || t.remove(), this._element.removeAttribute("aria-describedby"), g.trigger(this._element, this.constructor.eventName("hidden")), this._disposePopper())
                    }, this.tip, this._isAnimated())
                }
            }
        }
        ...
        _getTemplateFactory(e) {
            return this._templateFactory ? this._templateFactory.changeContent(e) : this._templateFactory = new zn({ ...this._config,
                content: e,
    ...
    class li extends t {
        ...
        _process(e) {
            this._activeTarget !== e && (this._clearActiveClass(this._config.target), (this._activeTarget = e).classList.add(ri), this._activateParents(e), g.trigger(this._element, "activate.bs.scrollspy", {
                relatedTarget: e
            }))
        }
        _activateParents(e) {
            if (e.classList.contains("dropdown-item")) d.findOne(".dropdown-toggle", e.closest(".dropdown")).classList.add(ri);
                ...
                for (const t of d.parents(e, ".nav, .list-group"))
                    for (const n of d.prev(t, ".nav-link, .nav-item > .nav-link, .list-group-item")) n.classList.add(ri)
        }
        _clearActiveClass(e) {
    ...
    class fi extends t {
        ...
        _activate(e, t) {
            e && (e.classList.add(P), this._activate(r(e)), this._queueCallback(() => {
                "tab" !== e.getAttribute("role") ? e.classList.add(hi) : (e.removeAttribute("tabindex"), e.setAttribute("aria-selected", !0), this._toggleDropDown(e, !0), g.trigger(e, "shown.bs.tab", {
                    relatedTarget: t
                }))
        ...
        _deactivate(e, t) {
            e && (e.classList.remove(P), e.blur(), this._deactivate(r(e)), this._queueCallback(() => {
                "tab" !== e.getAttribute("role") ? e.classList.remove(hi) : (e.setAttribute("aria-selected", !1), e.setAttribute("tabindex", "-1"), this._toggleDropDown(e, !1), g.trigger(e, "hidden.bs.tab", {
                    relatedTarget: t
                }))
            }, e, e.classList.contains("fade")))
        }
        _keydown(e) {
            var t;
            ["ArrowLeft", ci, "ArrowUp", ui].includes(e.key) && (e.stopPropagation(), e.preventDefault(), t = [ci, ui].includes(e.key), (e = U(this._getChildren().filter(e => !a(e)), e.target, t, !0)) && (e.focus({
                preventScroll: !0
